...
//! docs/jdk-only/W7-22-shadow-retirement-logging-and-time.md §5.
...
struct Slots {
    ...
    /// reading `docs/jdk-only/D3-1-simpledateformat-format-zone-arm.md`.
...
fn gather(
    ...
    // `docs/jdk-only/D3-1-simpledateformat-format-zone-arm.md` and
...
pub(crate) fn register_date_format_fast(r: &mut NativeMethodRegistry) {
    ...
    // `docs/jdk-only/G28-1-the-dst-rule-layer-rebuilt-20260817.md`.
