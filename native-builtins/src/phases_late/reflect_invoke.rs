...
pub(crate) fn register_p59_module(r: &mut NativeMethodRegistry) {
    ...
    // docs/jdk-only/E20-R11-INTERSECTION-BLIND-GUARD-20260813.md §4.1.
    ...
    // narrower.
    //
    // See docs/jdk-only/E4-R11-CLASS-PATH-MODULE-BOOT-LAYER-FIX-20260813.md
    // (§4.1 and NOM E-7) and docs/jdk-only/E16-R11-P59-MODULE-LAYER-TWIN-20260813.md.
    r.register(ml, "modules", "()Ljava/util/Set;", |ctx, args| {
        ...
        // See docs/jdk-only/E28-R11-P59-MODULE-WIDTHS-AND-CATALOG-20260813.md,
    ...
    r.register(
        ...
        |ctx, args| {
            ...
            // docs/jdk-only/E28-R11-P59-MODULE-WIDTHS-AND-CATALOG-20260813.md.
            let desc =
