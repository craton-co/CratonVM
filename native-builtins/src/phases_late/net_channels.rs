...
pub(crate) fn register_p58_nio_channels(r: &mut NativeMethodRegistry) {
    ...
    // docs/jdk-only/W7-9-minted-interface-abstract-methods.md §5.
    ...
    // are nominated in
    // docs/jdk-only/E21-1-getstatic-has-no-native-path.md.
...
pub(crate) fn register_datagram_channel(r: &mut NativeMethodRegistry) {
    ...
    // slot-index species
    // (docs/jdk-only/W4-4-slot-index-species-sweep.md), i.e.
    ...
    // datagram — is in
    // docs/jdk-only/W7-9-minted-interface-abstract-methods.md.
