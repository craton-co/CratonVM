...
//
// See docs/jdk-only/E13-1-the-six-builders-decode-a-reference-as-an-int.md
// ---------------------------------------------------------------------------
...
fn register_http_client(r: &mut NativeMethodRegistry) {
    ...
    r.register(
        ...
        |ctx, args| {
            ...
            // docs/jdk-only/D3-2-http2-optional-reference-layout.md
...
fn register_http_request(r: &mut NativeMethodRegistry) {
    ...
    r.register(cls, "version", "()Ljava/util/Optional;", |ctx, args| {
        ...
        // docs/jdk-only/E13-1-the-six-builders-decode-a-reference-as-an-int.md
        let opt = try_alloc_concurrent_synthetic(ctx, "java/util/Optional", 1)?;
        if ver > 0 {
...
mod http2_tests {
    ...
    //
    // See docs/jdk-only/E2-1-optional-reference-layout-landed.md
