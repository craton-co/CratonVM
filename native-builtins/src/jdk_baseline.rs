...
//!
//! `docs/jdk-only/E25-R11-GUARD-POPULATION-SWEEP-20260813.md` §7
...
//! `docs/jdk-only/E32-R11-JDK-BASELINE-CAPABILITY-20260813.md`.
//!
...
pub(crate) fn parse(text: &'static str) -> Baseline {
    ...
    assert_eq!(
        ...
        "unknown jdk-baseline format version {format:?}. The row grammar changed under this \
         parser; read \
         docs/jdk-only/E32-R11-JDK-BASELINE-CAPABILITY-20260813.md §2 before \
         widening this check."
    );
    assert!(
...
mod tests {
    ...
    // docs/jdk-only/E41-R11-TWELVE-GUARDS-CONVERTED-20260813.md.
