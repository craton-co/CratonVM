...
/// (per `kc16-blocker-map.md`'s KC16 investigation) walks
...
fn jboss_logger_emit(ctx: &mut dyn NativeContext, args: &[Value], level: &str) {
    ...
    // See propertiesmigration-logfactory-oom-residual-FIXED.md.
...
fn stamp_inferred_caller(ctx: &mut dyn NativeContext, record: &mut ObjectRef) {
    ...
    *record = ctx.read_native_pin(record_pin, *record);
    ...
    // and none of them reads this flag. W7-56-infercaller-strict-RETIRED-20260917.md
...
fn publish_to_jul_handlers_full(
    ...
    let result: Result<bool, MethodCallFailed> = (|| {
        ...
        // (dohead-post-fix-sporadic-residuals-FIXED.md).
        let record_pin = ctx.pin_native_root(record);
...
/// overloads'.
///
/// Recorded in docs/jdk-only/W7-25-jul-getlogger-regression.md;
...
/// docs/jdk-only/W7-25-jul-getlogger-regression.md §7.
...
// docs/jdk-only/G15-1-the-jul-null-axis-and-how-far-RJdkIntrinsics3-got-20260817.md
...
pub fn register_logmanager_natives(registry: &mut NativeMethodRegistry) {
    ...
    // `julogger-cast-to-jbosslogmanager-logger-20260817-FIXED.md`) made this the
