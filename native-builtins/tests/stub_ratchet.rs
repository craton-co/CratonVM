...
const BASELINE_SYNTHETIC_STUBS_MANAGEMENT: usize = 4506;
...
/// generic fallback `java/io/InputStream.readAllBytes` stub (+1) matching
/// `transferTo`. Net stub delta: -1.
const BASELINE_SYNTHETIC_STUBS_NO_MANAGEMENT: usize = 4479;
...
const BASELINE_SYNTHETIC_STUBS_SYNTHETIC_JDK: usize = 4479;
...
const MEASURED_TOTAL_REGISTRATIONS_MANAGEMENT: usize = 14205;
...
/// on and off. The +1 is the previous wave's: lane 1's wave 7 measured this
/// number on its landing tree and re-froze the stub baselines without it.
const MEASURED_TOTAL_REGISTRATIONS_NO_MANAGEMENT: usize = 13837;
