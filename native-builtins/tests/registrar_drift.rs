...
/// `docs/known-issues/jdk-only/synthetic-bigdecimal-comparison-keeps-the-f64-body-20260917.md`.
const BASELINE_TOTAL_DRIFT: usize = 1272;
...
/// gate counts registrations, not whether their bodies agree. See
/// `docs/known-issues/jdk-only/synthetic-bigdecimal-comparison-keeps-the-f64-body-20260917.md`.
const BASELINE_TOTAL_PAIRS: usize = 1408;
