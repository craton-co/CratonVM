...
| [`hardware-bring-up.md`](hardware-bring-up.md) | **Start here with a CUDA device in front of you.** Which backend builds on which OS, the first run, the drain witness and its negative control, the gate battery, and what is still waiting on hardware. |
