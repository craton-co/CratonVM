...
- JFR's `StringPool` (`jfr/src/dump.rs:185`) is `Arc<[u8]>`-keyed for binary JFR-format strings; not interchangeable with `rustjvm_types::intern_arc` (`Arc<str>`, UTF-8). No unification opportunity.
