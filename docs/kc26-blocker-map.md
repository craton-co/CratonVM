...
under `target/release/rustjvm.exe` built from T18 + Session 92/93 fixes.
...
Binary: `C:\craton\rust-jvm\target/release/rustjvm.exe` (T18)
Workload: `C:\craton\keycloak-26.2.4\lib\quarkus-run.jar`
JDK: `C:\craton\jdk-21.0.6`

## 1. Phase-by-phase timeline

All timestamps from `RUST_LOG=rustjvm_vm=trace` run (`/tmp/kc26_d14_stderr.txt`,
