...
```rust
        ...
        // docs/jdk-only/E16-R11-P59-MODULE-LAYER-TWIN-20260813.md §1.
```
...
### NOM E16-3 — `docs/jdk-only/E4-R11-CLASS-PATH-MODULE-BOOT-LAYER-FIX-20260813.md` §6 NOM E-7 — correct and close it
