...
>   `docs/jdk-only/W7-30-stub-ratchet-boot-path-scope.md`, which is
...
`docs/jdk-only/W7-9-minted-interface-abstract-methods.md` (the
...
`docs/jdk-only/W7-5-registrars-that-never-shipped.md`.
