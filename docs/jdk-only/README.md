...
> [`../known-issues/jdk-only/lane-4-io-nio-foreign.md`](../known-issues/jdk-only/lane-4-io-nio-foreign.md).
> **For where `--jdk-only` actually stands, read
> [`../known-issues/jdk-only/the-six-acceptance-criteria-measured-20260910.md`](../known-issues/jdk-only/the-six-acceptance-criteria-measured-20260910.md)
> instead of §1 below**, and for the backlog that followed the campaign's
> close, read
> [`../known-issues/jdk-only/lane-backlog-baseline-and-diagnostics-20260917.md`](../known-issues/jdk-only/lane-backlog-baseline-and-diagnostics-20260917.md).
