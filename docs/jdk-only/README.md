...
> **2026-09-17: this page and `../known-issues/jdk-only/INDEX.md` are now HISTORICAL.** The campaign
> both describe — removing every synthetic bridge shadowing real bytecode
> under `--jdk-only` — closed between 2026-09-10 and 2026-09-16: lanes L0, L1,
> L2, L3, L5, L6, L7 and LT all `RETIRED`
> (`docs/internal/jdk-only/lane-0-integration-and-gates-RETIRED-20260916.md`).
> Lane L4 is still active — see
> [`../internal/retired/lane-4-io-nio-foreign-RETIRED-20260920.md`](../internal/retired/lane-4-io-nio-foreign-RETIRED-20260920.md).
> **For where `--jdk-only` actually stands, read
> [`../internal/jdk-only/the-six-acceptance-criteria-measured-20260910-RETIRED-20260921.md`](../internal/jdk-only/the-six-acceptance-criteria-measured-20260910-RETIRED-20260921.md)
> instead of §1 below**, and for the backlog that followed the campaign's
> close, read
> [`lane-backlog-baseline-and-diagnostics-20260917-RETIRED-20260921.md`](../internal/jdk-only/lane-backlog-baseline-and-diagnostics-20260917-RETIRED-20260921.md).
> Everything below this notice is kept for its history and its rules-of-thumb
> (§2's four numbered rules have not been superseded), not for its headline
> counts, which were already three-times-wrong before the campaign closed.
>
> **Start at [`../known-issues/jdk-only/INDEX.md`](../known-issues/jdk-only/INDEX.md)** (added 2026-08-13, lane C18): one line per
...
> stated rather than guessed. `../known-issues/jdk-only/INDEX.md` was rebuilt again on **2026-08-17**
...
README's own exclusion rule mechanically — this file, `../known-issues/jdk-only/INDEX.md`, `HANDOFF-*`,
...
* Related non-known-issue docs:
  [`docs/jdk-only-runtime-services.md`](../known-issues/jdk-only/runtime-services-blocker-inventory.md),
...
| `jul-logrecord-infercaller-is-inert-under-jdk-only-20260812.md` | SUPERSEDED — now jdk-only-jul-logrecord-infercaller-SUPERSEDED-20260812.md, carrying a marker that points at W7-56-infercaller-strict.md, which measured it and fixed it. **Both of its candidate causes are refuted**: the setters stick, and our `StackWalker` hands `CallerFinder` exactly the frame list HotSpot's walks. Row added here 2026-08-12 and the stale §2.1 row for it deleted — it had survived the move. HANDOFF-20260812.md still lists this as an unreconciled README item and is now stale on it. |
