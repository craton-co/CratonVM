...
**File:** `docs/jdk-only/G33-1-the-instrument-that-under-reported-20260817.md`.
...
* **Did not edit `native-api/src/registry.rs`, `vm/src/vm/vm_exec.rs`,
  ...
  `dispatch_virtual.rs`, `native_override.rs`, `../known-issues/jdk-only/INDEX.md` or `README.md`.**
