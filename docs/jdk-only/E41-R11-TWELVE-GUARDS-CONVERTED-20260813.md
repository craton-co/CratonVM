...
`kind_four_catches_two_of_the_ten_cds_registrations_not_five` (renamed by
F23-1; the "five" was three real natives plus two real fabrications — see
`F23-1-the-guard-that-could-not-see-a-private-native-20260813.md` §3.1).
...
/// and docs/jdk-only/E41-R11-TWELVE-GUARDS-CONVERTED-20260813.md.
#[cfg(test)]
...
```rust
    ...
    ///
    /// See docs/jdk-only/E41-R11-TWELVE-GUARDS-CONVERTED-20260813.md
