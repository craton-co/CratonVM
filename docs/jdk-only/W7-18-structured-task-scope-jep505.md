...
docs/jdk-only/W7-14-fjp-common-factory-bound-by-name.md swept this
...
That is the shape docs/jdk-only/W7-5-registrars-that-never-shipped.md
censuses, and the shape
docs/jdk-only/W7-14-fjp-common-factory-bound-by-name.md named for
...
docs/jdk-only/W7-14-fjp-common-factory-bound-by-name.md, and it was
...
* *The deletion is checkable.* **False.** Roughly twenty `#[test]`s in
  ...
  docs/jdk-only/W6-5-vacuous-tests.md warns about from the other
