...
> NOMINATION N1 in `../known-issues/jdk-only/INDEX.md`: `vm/src/runtime/interpreter/typecheck.rs:782`
...
```rust
            ...
            // See docs/jdk-only/W8-C10-1-typecheck-hatch-audit-and-aastore-precedence.md
            {
...
```rust
    ...
    // docs/jdk-only/W7-101-aastore-interface-component-blanket.md
    assert!(
        !aastore_element_assignable(&shared, iface_arr, beta_obj),
