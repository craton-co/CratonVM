...
## NOMINATION 5 — `docs/known-issues/jdk-only/../known-issues/jdk-only/INDEX.md`: list this family

`../known-issues/jdk-only/INDEX.md` lists **none** of `E12-1`, `E22-1`, `E31-1` or this record, though
they are one continuous investigation across four lanes. New `.md` files under
this directory are this lane's to create; `../known-issues/jdk-only/INDEX.md` is not. Add all four,
