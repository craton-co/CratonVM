...
4. **The embedded-Tomcat HTTPS fixture** (`../known-issues/jdk-only/P4A-TOMCAT-20260812.md` §2):
...
## NOMINATION 1 — `docs/known-issues/jdk-only/../known-issues/jdk-only/INDEX.md` (not this lane's file)
