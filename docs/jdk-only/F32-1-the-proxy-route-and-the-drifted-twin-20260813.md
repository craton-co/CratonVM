...
### N4 — `docs/known-issues/jdk-only/../known-issues/jdk-only/INDEX.md`: add the row for this record

Not applied: another lane is mid-edit on `../known-issues/jdk-only/INDEX.md` in this worktree
