...
```rust
            (
                ...
                "NOT REGISTERED, and never triaged: this overload was missing from \
                 ...
                 docs/jdk-only/E20-R11-INTERSECTION-BLIND-GUARD-20260813.md.",
            ),
```
        ...
        if std::env::var("CRATONVM_REQUIRE_E2E").is_ok() {
            panic!(
                "jck_regression_gate: .class files not available, and \
                 ...
                 jdk-regression-baseline.md; with no corpus it enforces \
                 nothing."
            );
        }
        eprintln!(
...
```rust
    ...
    /// docs/jdk-only/E25-R11-GUARD-POPULATION-SWEEP-20260813.md §5.
    /// Asserted as a
```
