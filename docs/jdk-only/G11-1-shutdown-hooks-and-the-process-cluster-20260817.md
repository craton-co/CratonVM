...
>   included. See `../known-issues/jdk-only/INDEX.md` §B.3.
...
>   `CRATONVM_DISABLE_INTRINSICS=1`, where the counter is exact. See `../known-issues/jdk-only/INDEX.md`
>   §B.1.
...
* **It did not edit `RShutdownHooks.java`, `run.sh`, `../known-issues/jdk-only/INDEX.md` or
