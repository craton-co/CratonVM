...
```
cratonvm.exe --java-home "C:\craton\jdk-21.0.6" --Xmx 1g \
...
2. **Add a graceful-shutdown mechanism** to CratonVM so hung boots still dump the audit log. Options:
