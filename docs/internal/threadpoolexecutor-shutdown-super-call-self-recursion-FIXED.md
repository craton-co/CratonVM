...
`docs/internal/wildfly-domain-hostcontroller-sigsegv-inline-cache-null-receiver-FIXED.md`) was
...
`docs/internal`/memory rule "invokespecial always prefers native over bytecode." A native IS
