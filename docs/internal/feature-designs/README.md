...
| [`activate-ir-optimizer.md`](activate-ir-optimizer.md) | Broaden GVN/const-fold/DSE/LICM + escape→scalar-replacement past the narrow gated IR path (fix the φ/branch dam). | L | guard-surviving SR ← deopt |
