...
`performance/vm-per-call-dispatch-cost-RETIRED-20260817.md`, which was
...
`performance/vm-per-call-dispatch-cost-RETIRED-20260817.md`.
...
* `performance/vm-per-call-dispatch-cost-RETIRED-20260817.md` — the VM-wide per-call dispatch cost this belongs to.
