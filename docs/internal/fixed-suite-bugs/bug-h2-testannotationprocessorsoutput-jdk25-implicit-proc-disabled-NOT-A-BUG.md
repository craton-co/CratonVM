...
[bug-h2-formatter-datetime-conversion-unimplemented.md](../../internal/fixed-suite-bugs/h2-suite-bugs/bug-h2-formatter-datetime-conversion-unimplemented.md):
...
## Severity
**N/A** — not a bug. Filed under `h2-suite-bugs/` per investigation-tracking
