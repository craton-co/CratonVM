# CratonVM Spring suite genuine-bug list — archived history (pre 2026-07-27 third session)

This is the verbatim content of `docs/known-issues/CRATONVM-SPRING-GENUINE-BUGLIST.md`
as it stood before the 2026-07-27 third session. It is kept for the
root-cause narratives and repro recipes it carries; **its status tables and
conclusions are superseded** by the live doc, which now tracks a much smaller
residual set. Where the two disagree, the live doc wins.
