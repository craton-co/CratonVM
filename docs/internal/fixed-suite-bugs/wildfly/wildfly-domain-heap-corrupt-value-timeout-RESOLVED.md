...
- **Real bugs found and fixed along the way (all merged to `origin/dev`):**
  - Host Controller SIGSEGV — fabricated compact-field slots corrupting a JIT inline `getfield`/inline-cache dispatch (`ReentrantLock.lock()`); doc retired to `wildfly-domain-hostcontroller-sigsegv-inline-cache-null-receiver-FIXED.md`, commit `750803e3`.
...
**New repro:** `../../../known-issues/repros/wildfly-domain-startup-timeout/FieldSpawn.java`
...
Keep this document under `../../../known-issues` for now. The specific process-controller
...
gap already tracked in `../../gaps/kc16-blocker-map.md`'s KC16
...
See `../java-lang-ref-cleaner-static-native-half-initialized-object-FIXED.md`.
...
line. This doc stays in `../../../known-issues`.
