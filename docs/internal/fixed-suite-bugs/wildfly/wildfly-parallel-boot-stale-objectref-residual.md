...
- ~~A debug-build assertion that validates every `ObjectRef` read...~~ — **IMPLEMENTED** later in
  ...
  [[wildfly-stale-objectref-debug-assertion-scoping]] (`wildfly-stale-objectref-debug-assertion-scoping.md`)
...
deadlock documented in `wildfly-gc-barrier-boot-hang-and-harness-fixes.md`
