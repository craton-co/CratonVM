...
`wildfly-invoke-virtual-lambda-sam-compat-stale-locals-FIXED.md`)
...
stack-only conservative scan — `../../../known-issues/README.md`'s A1-A5 table,
...
- `../../../known-issues/README.md`'s 2026-07-10 entry retiring
...
family (`../tomcat/dohead-jit-heap-corruption-register-invisibility-FIXED.md`'s
...
`../../../feature-designs/precise-jit-maps-default.md`), not a targeted patch at
...
- `../tomcat/dohead-jit-heap-corruption-register-invisibility-FIXED.md`,
  `docs/internal/tomcat-08-07/swallowabortedupploads-unexpected-socketexception-RESOLVED.md`,
  `../../../known-issues/README.md` (2026-07-10 AccessLogValve/RewriteValve
  entry) — the three prior independent occurrences of this same family this
  doc's conclusion is based on.
- `../../../feature-designs/precise-jit-maps-default.md` — the roadmap doc for
...
— see `wildfly-invoke-virtual-lambda-sam-compat-stale-locals-FIXED.md` for
...
(`../../../feature-designs/precise-jit-maps-default.md`, SB-CRASH-04); per standing policy no targeted
...
`wildfly-cce0079-young-start-set-truncation-FIXED.md`. Summary:
