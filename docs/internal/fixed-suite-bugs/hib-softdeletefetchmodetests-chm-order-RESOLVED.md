...
Supersedes [`docs/known-issues/hib-softdeletefetchmodetests-statemanagement-null-npe.md`](../../known-issues/hib-softdeletefetchmodetests-statemanagement-null-npe.md) (removed from `docs/known-issues/` by this fix).
