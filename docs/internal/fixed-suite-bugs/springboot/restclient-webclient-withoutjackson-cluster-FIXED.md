...
covered by
[`junit5-interceptingexecutableinvoker-layout-probe-livelock-cluster-FIXED.md`](ableinvoker-layout-probe-livelock-cluster-FIXED.md)
and the (now-fixed)
[`observationregistry-conditionalonmissingbean-classpathexclusions-FIXED.md`](tionalonmissingbean-classpathexclusions-FIXED.md)).
