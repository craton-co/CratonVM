...
| `module/spring-boot-micrometer-metrics` | `org.springframework.boot.micrometer.metrics.autoconfigure.export.influx.InfluxMetricsExportAutoConfigurationTests` (3 of 4 tests; the former separate `getMethods()` cluster is fixed, see [`../../internal/springboot/class-getmethods-override-shadowing-duplicate-close-cluster-FIXED.md`](-shadowing-duplicate-close-cluster-FIXED.md)) |
