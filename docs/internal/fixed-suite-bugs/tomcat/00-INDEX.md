...
| [23](23-charsetcache-pathological-slowdown.md) | `CharsetCache` cached paths lost to uncached because compiled Java calls were forced through generic dispatch; the direct-call gate and warm-native cache identity/policy/census residual are repaired | TestCharsetCachePerformance | PASS/perf | ✅ **FIXED** (2026-08-01; exact JUnit `OK (1 test)`, full/lazy 0.556x/0.543x uncached; JIT/no-JIT semantic and cache-census probes green) |
