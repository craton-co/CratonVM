...
| item | disposition |
|---|---|
| 32.1 | Moved to [jit-raw-jit-to-jit-shadow-stack-overflow](../../../known-issues/jit-raw-jit-to-jit-shadow-stack-overflow-20260731.md) (and its context in [jit-optimizing-tier-disabled-by-moving-young-default](../../../known-issues/jit-optimizing-tier-disabled-by-moving-young-default.md)). Cause 1 fixed 07-30; the entire residual is the raw JIT-to-JIT direct-call edge, whose gate stays closed. No Tomcat work. |
