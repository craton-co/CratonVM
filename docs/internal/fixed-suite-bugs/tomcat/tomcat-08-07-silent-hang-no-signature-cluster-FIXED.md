...
closed; this document is archived under `..`.
...
see `../../../feature-designs/jit-local-exception-handlers.md` for the full
...
common idiom. Should get a `../../../feature-designs` writeup and its own
...
`../../../feature-designs/jit-local-exception-handlers.md`'s "session 2"
section. This doc's disposition is unchanged (stays open) pending that
follow-up.

### Doc disposition

Left in `../../../known-issues` (not fixed) with this root cause recorded in
...
`../../../feature-designs/jit-local-exception-handlers.md`. `Response
...
`../../../feature-designs/deopt-osr.md` confirms this is by design: "Every
