...
| 43 | Bottom-tested loops refuse the IR build | FIXED 58ede83bd (caller code), 762ed3ced (spliced callee bodies); `ir-builder-refuses-rotated-loops-FIXED-20260912.md` |
...
| 49 | Allocation elision never fires by default | FIXED 26c880f88; `allocation-elision-never-fires-by-default-FIXED-20260912.md` |
...
| 55 | Tier state, OSR denials, unload keyed by class name | FIXED f960bed8f, c9cf67009, then the verdict store on `fix/jit-review-r2-20260912-verdicts`; `jit-verdicts-are-keyed-by-name-not-loader-FIXED-20260912.md`; the site-trap refusal memo writer used the wrong key: `site-trap-refusal-memo-written-under-the-wrong-key-FIXED-20260912.md` |
...
| 80 | Intrinsics: layout twice, exact CP class, env read per call | FIXED 7335f4c73, e9838de83, the subclass resolver on `fix/jit-review-r2-20260912-verdicts`, then the final-devirt yield and IR-tier subclass match on `fix/jit-review-r2-20260912`; `atomic-intrinsics-miss-subclass-call-sites-FIXED-20260912.md` |
...
| 88 | Resume tolerates Unsupported locals on a wrong argument | FIXED on `fix/jit-review-r2-20260912-verdicts` (compile-time liveness contract pinned, argument rewritten), then unspilled register indices refused at admission; `jit-resume-tolerates-unsupported-locals-without-liveness-FIXED-20260912.md` |
