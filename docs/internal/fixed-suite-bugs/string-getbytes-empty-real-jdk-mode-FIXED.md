...
Date observed: 2026-07-14, while verifying [`keycloak/keycloak-testclassserver-invalidpackage-classnotfound-FIXED.md`](keycloak/keycloak-testclassserver-invalidpackage-classnotfound-FIXED.md) (now moved to `..` as FIXED) on the Azure Linux build host.
...
0`" symptom noted in
[`keycloak/keycloak-testclassserver-invalidpackage-classnotfound-FIXED.md`](keycloak/keycloak-testclassserver-invalidpackage-classnotfound-FIXED.md)'s
...
`en_US` instead of throwing. Moved to `..` alongside this doc.
