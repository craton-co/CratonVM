...
4. **This exact class of gap has already been found and fixed once**, in a
   sibling code path — see `spring/spring-aop-lambda-hidden-class-pointcut-matching-RESOLVED.md`.
...
- `spring/spring-aop-lambda-hidden-class-pointcut-matching-RESOLVED.md`
