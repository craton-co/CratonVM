...
`../../../known-issues` and prior investigation notes. Previously these lived only in gitignored locations
...
| `bug06-fam5-…` | `bug06-fam5-reflection-null/Refl5.java` | ✅ **CLOSED 2026-07-02** — probe ==HotSpot in nojit+jit on dev `ffb247e5`; the suite-level `getDeclaredMethod on null` ×28 is extinct (0 instances in the clean 2026-06-30/07-01 re-runs + fresh 196-class sweep). Doc: `../bug06-fam5-reflection-getdeclaredmethod-null.md`. |
