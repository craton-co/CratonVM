public final class VArgLen {
    static final int minDepth = 4;
    static class TreeNode { TreeNode left, right; }
    static int itemCheck(TreeNode node) { return node.left == null ? 1 : 1 + itemCheck(node.left) + itemCheck(node.right); }
