...
- `BCFIPSECDSACryptoProviderTest` — the documented crash
  ...
  **gone**. `AlgorithmParameters.getInstance("EC")` now correctly returns a real
  ...
  [crypto-fips1402-sunec-keypairgenerator-384bit-gap.md](../../known-issues/keycloak-07-04/crypto-fips1402-sunec-keypairgenerator-384bit-gap.md).
...
## Residual (separate, pre-existing, tracked separately)
