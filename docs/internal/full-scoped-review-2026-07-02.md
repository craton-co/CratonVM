...
Scope: all repository files except `apps/` and `docs/internal/`, per the
...
- `docs/COVERAGE.md` explicitly says coverage is informational and
  non-blocking.
...
- `README.md:26` highlights coverage CI, but `docs/COVERAGE.md` says the job is
