...
|---|---|---|---|---|---|---|
| 2^20 (1.1M) | 155ms | 19ms | 21ms | 2ms | 1.1× | 10.5× | ✓ |
| 2^22 (4.2M) | 747ms | 31ms | 28ms | 6ms | 0.9× | 4.7× | ✓ |
| 2^24 (17M) | 2416ms | 83ms | 28ms | 19ms | 0.3× | 1.5× | ✓ |
| 2^26 (68M) | 10508ms | FAILms | 55ms | 77ms | - | 0.7× | ✓ |

## GpuProbe.vaddMap — out\[i\]=a\[i\]+b\[i\] (memory-bound, checksums)

| N | CratonVM (checksum) | HotSpot (checksum) | TornadoVM GPU |
|---|---|---|---|
| 2^20 (1.1M) | CS:550279050800 | CS:550279050800 | 3ms CS:550279050800 |
| 2^22 (4.2M) | CS:8798185971448 | CS:8798185971448 | 7ms CS:8798185971448 |
| 2^24 (17M) | CS:140745860167760 | CS:140745860167760 | 33ms CS:140745860167760 |
| 2^26 (68M) | CS:- | CS:2251833301005528 | 90ms CS:2251833301005528 |
