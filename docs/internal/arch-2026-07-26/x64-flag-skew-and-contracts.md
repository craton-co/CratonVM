...
| `HEADER_SIZE as u8` inside a literal instruction byte array | 17 | **disp8** / imm8 | 23746, 23755, 23981, 24104, 24107, 24232, 25130, 25142, 25199, 25211, 25366, 25369, 26068, 26086, `emit_bulk_zero_byte_fill_preheader`, `emit_bulk_set_byte_stride_preheader`, `emit_byte_sieve_preheader` |
...
| `ARRAY_LENGTH_OFFSET as u8` | 19 | **disp8** | 17289, 17452, 18886, 18976, 23706, 23716, 23968, 24064, 24068, 24234, 25094, 25175, 25220, 25351, 25354, 26042, `emit_bulk_zero_byte_fill_preheader`, `emit_bulk_set_byte_stride_preheader`, `emit_byte_sieve_preheader` |
...
compile-time-arithmetic uses, **24** `ARRAY_LENGTH_OFFSET` sites, **23** other named
header-offset sites. **110 sites** in this file.
