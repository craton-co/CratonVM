...
[`docs/internal/tomcat-suite-bugs/04-embedded-server-throughput-wall-OPEN.md`](../../internal/fixed-suite-bugs/tomcat/04-embedded-server-throughput-wall-OPEN.md),
