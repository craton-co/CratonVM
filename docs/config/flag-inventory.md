...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,142 |
| exact string literals (i.e. actually named by code, not prose) | 1,074 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1068** |
...
1079 rows: 1068 declared, 11 allowlisted. Generated by
