...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,163 |
| exact string literals (i.e. actually named by code, not prose) | 1,095 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1089** |
...
1100 rows: 1089 declared, 11 allowlisted. Generated by
