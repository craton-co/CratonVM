...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,343 |
| exact string literals (i.e. actually named by code, not prose) | 1,268 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1262** |
...
1273 rows: 1262 declared, 11 allowlisted. Generated by
