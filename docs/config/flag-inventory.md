...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,190 |
| exact string literals (i.e. actually named by code, not prose) | 1,121 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1115** |
...
1126 rows: 1115 declared, 11 allowlisted. Generated by
