...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,371 |
| exact string literals (i.e. actually named by code, not prose) | 1,296 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1290** |
...
1301 rows: 1290 declared, 11 allowlisted. Generated by
