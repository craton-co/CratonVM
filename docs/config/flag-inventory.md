...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,238 |
| exact string literals (i.e. actually named by code, not prose) | 1,164 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1158** |
...
1169 rows: 1158 declared, 11 allowlisted. Generated by
