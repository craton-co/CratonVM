...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,175 |
| exact string literals (i.e. actually named by code, not prose) | 1,106 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1100** |
...
1111 rows: 1100 declared, 11 allowlisted. Generated by
