...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,410 |
| exact string literals (i.e. actually named by code, not prose) | 1,335 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1329** |
...
1340 rows: 1329 declared, 11 allowlisted. Generated by
