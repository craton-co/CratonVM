...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,166 |
| exact string literals (i.e. actually named by code, not prose) | 1,098 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1092** |
...
1103 rows: 1092 declared, 11 allowlisted. Generated by
