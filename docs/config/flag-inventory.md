...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,403 |
| exact string literals (i.e. actually named by code, not prose) | 1,328 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1322** |
...
1333 rows: 1322 declared, 11 allowlisted. Generated by
