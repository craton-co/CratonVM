...
<<<<<<< HEAD
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **796** |
=======
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **796** |
>>>>>>> origin/dev
...
807 rows: 796 declared, 11 allowlisted. Generated by
...
| `CRATONVM_DBG_ZGC_PINS` | DBG | `CRATONVM_DBG=zgc-pins` | opt-in | off | diag | snapshot | gc |
