...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,377 |
| exact string literals (i.e. actually named by code, not prose) | 1,302 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1296** |
...
1307 rows: 1296 declared, 11 allowlisted. Generated by
