...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,342 |
| exact string literals (i.e. actually named by code, not prose) | 1,267 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1261** |
...
1272 rows: 1261 declared, 11 allowlisted. Generated by
