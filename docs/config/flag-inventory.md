...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,225 |
| exact string literals (i.e. actually named by code, not prose) | 1,152 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1146** |
...
1157 rows: 1146 declared, 11 allowlisted. Generated by
