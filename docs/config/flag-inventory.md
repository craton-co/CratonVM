...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,288 |
| exact string literals (i.e. actually named by code, not prose) | 1,213 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1207** |
...
1218 rows: 1207 declared, 11 allowlisted. Generated by
