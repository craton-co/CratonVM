...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,265 |
| exact string literals (i.e. actually named by code, not prose) | 1,192 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1186** |
...
1197 rows: 1186 declared, 11 allowlisted. Generated by
