...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,181 |
| exact string literals (i.e. actually named by code, not prose) | 1,112 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1106** |
...
1117 rows: 1106 declared, 11 allowlisted. Generated by
