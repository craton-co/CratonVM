...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,150 |
| exact string literals (i.e. actually named by code, not prose) | 1,082 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1076** |
...
1087 rows: 1076 declared, 11 allowlisted. Generated by
