...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,324 |
| exact string literals (i.e. actually named by code, not prose) | 1,249 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1243** |
...
1254 rows: 1243 declared, 11 allowlisted. Generated by
