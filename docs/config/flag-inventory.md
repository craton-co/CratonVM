...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,291 |
| exact string literals (i.e. actually named by code, not prose) | 1,216 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1210** |
...
1221 rows: 1210 declared, 11 allowlisted. Generated by
