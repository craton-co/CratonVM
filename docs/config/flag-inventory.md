...
| exact string literals (i.e. actually named by code, not prose) | 1,149 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1143** |
...
1154 rows: 1143 declared, 11 allowlisted. Generated by
