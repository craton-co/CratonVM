...
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **990** |
...
1001 rows: 990 declared, 11 allowlisted. Generated by
...
| `CRATONVM_G1_IGNORE_FINALIZER_GATE` | GC | `CRATONVM_GC=g1-ignore-finalizer-gate` | opt-in | off | behaviour | snapshot | gc |
