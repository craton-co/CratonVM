...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,169 |
| exact string literals (i.e. actually named by code, not prose) | 1,101 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1095** |
...
1106 rows: 1095 declared, 11 allowlisted. Generated by
