...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,161 |
| exact string literals (i.e. actually named by code, not prose) | 1,093 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1087** |
...
1098 rows: 1087 declared, 11 allowlisted. Generated by
