...
|---|---|
<<<<<<< HEAD
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,199 |
| exact string literals (i.e. actually named by code, not prose) | 1,130 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1124** |
=======
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,201 |
| exact string literals (i.e. actually named by code, not prose) | 1,132 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1126** |
>>>>>>> origin/dev
...
<<<<<<< HEAD
1135 rows: 1124 declared, 11 allowlisted. Generated by
=======
1137 rows: 1126 declared, 11 allowlisted. Generated by
>>>>>>> origin/dev
