...
| exact string literals (i.e. actually named by code, not prose) | 1,020 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1014** |
...
1025 rows: 1014 declared, 11 allowlisted. Generated by
