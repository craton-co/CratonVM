...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,171 |
| exact string literals (i.e. actually named by code, not prose) | 1,102 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1096** |
...
1107 rows: 1096 declared, 11 allowlisted. Generated by
