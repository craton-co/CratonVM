...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,257 |
| exact string literals (i.e. actually named by code, not prose) | 1,184 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1178** |
...
1189 rows: 1178 declared, 11 allowlisted. Generated by
