...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,246 |
| exact string literals (i.e. actually named by code, not prose) | 1,172 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1166** |
...
1177 rows: 1166 declared, 11 allowlisted. Generated by
