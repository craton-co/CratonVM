...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,389 |
| exact string literals (i.e. actually named by code, not prose) | 1,314 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1308** |
...
1319 rows: 1308 declared, 11 allowlisted. Generated by
