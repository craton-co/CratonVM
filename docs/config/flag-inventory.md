...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,266 |
| exact string literals (i.e. actually named by code, not prose) | 1,193 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1187** |
...
1198 rows: 1187 declared, 11 allowlisted. Generated by
