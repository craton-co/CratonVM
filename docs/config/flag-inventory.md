...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,305 |
| exact string literals (i.e. actually named by code, not prose) | 1,230 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1224** |
...
1235 rows: 1224 declared, 11 allowlisted. Generated by
