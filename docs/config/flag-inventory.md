...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,244 |
| exact string literals (i.e. actually named by code, not prose) | 1,170 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1164** |
...
1175 rows: 1164 declared, 11 allowlisted. Generated by
