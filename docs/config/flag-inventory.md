...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,120 |
| exact string literals (i.e. actually named by code, not prose) | 1,053 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1047** |
...
1058 rows: 1047 declared, 11 allowlisted. Generated by
