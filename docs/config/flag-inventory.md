...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,274 |
| exact string literals (i.e. actually named by code, not prose) | 1,200 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1194** |
...
1205 rows: 1194 declared, 11 allowlisted. Generated by
