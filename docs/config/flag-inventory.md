...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,187 |
| exact string literals (i.e. actually named by code, not prose) | 1,118 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1112** |
...
1123 rows: 1112 declared, 11 allowlisted. Generated by
