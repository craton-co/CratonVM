...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,178 |
| exact string literals (i.e. actually named by code, not prose) | 1,109 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1103** |
...
1114 rows: 1103 declared, 11 allowlisted. Generated by
