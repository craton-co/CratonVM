...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,259 |
| exact string literals (i.e. actually named by code, not prose) | 1,186 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1180** |
...
1191 rows: 1180 declared, 11 allowlisted. Generated by
