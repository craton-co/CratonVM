...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,138 |
| exact string literals (i.e. actually named by code, not prose) | 1,070 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1064** |
...
1075 rows: 1064 declared, 11 allowlisted. Generated by
