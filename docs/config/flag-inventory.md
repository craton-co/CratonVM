...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,076 |
| exact string literals (i.e. actually named by code, not prose) | 1,011 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1005** |
...
1016 rows: 1005 declared, 11 allowlisted. Generated by
