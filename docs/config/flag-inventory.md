...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,140 |
| exact string literals (i.e. actually named by code, not prose) | 1,072 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1066** |
...
1077 rows: 1066 declared, 11 allowlisted. Generated by
