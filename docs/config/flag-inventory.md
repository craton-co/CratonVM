...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,118 |
| exact string literals (i.e. actually named by code, not prose) | 1,051 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1045** |
...
1056 rows: 1045 declared, 11 allowlisted. Generated by
