...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,322 |
| exact string literals (i.e. actually named by code, not prose) | 1,247 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1241** |
...
1252 rows: 1241 declared, 11 allowlisted. Generated by
