...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,370 |
| exact string literals (i.e. actually named by code, not prose) | 1,295 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1289** |
...
1300 rows: 1289 declared, 11 allowlisted. Generated by
