...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,333 |
| exact string literals (i.e. actually named by code, not prose) | 1,258 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1252** |
...
1263 rows: 1252 declared, 11 allowlisted. Generated by
