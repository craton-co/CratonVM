...
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **694** |
...
705 rows: 694 declared, 11 allowlisted. Generated by
...
| `CRATONVM_DBG_OVERLAY` | DBG | `CRATONVM_DBG=overlay` | opt-in | off | diag | snapshot | native-builtins, vm |
