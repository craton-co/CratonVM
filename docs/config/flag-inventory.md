...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,268 |
| exact string literals (i.e. actually named by code, not prose) | 1,194 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1188** |
...
1199 rows: 1188 declared, 11 allowlisted. Generated by
