...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,179 |
| exact string literals (i.e. actually named by code, not prose) | 1,110 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1104** |
...
1115 rows: 1104 declared, 11 allowlisted. Generated by
