...
| exact string literals (i.e. actually named by code, not prose) | 1,176 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1170** |
...
1181 rows: 1170 declared, 11 allowlisted. Generated by
