...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,276 |
| exact string literals (i.e. actually named by code, not prose) | 1,202 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1196** |
...
1207 rows: 1196 declared, 11 allowlisted. Generated by
