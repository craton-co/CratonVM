...
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **878** |
...
889 rows: 878 declared, 11 allowlisted. Generated by
...
| `CRATONVM_NATIVE_SHADOW_SINK_CAP` | DBG | `CRATONVM_DBG=native-shadow-sink-cap` | opt-in | off | diag | snapshot | types, vm |
