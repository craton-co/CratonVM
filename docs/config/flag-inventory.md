...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,154 |
| exact string literals (i.e. actually named by code, not prose) | 1,086 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1080** |
...
1091 rows: 1080 declared, 11 allowlisted. Generated by
