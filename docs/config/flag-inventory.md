...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,226 |
| exact string literals (i.e. actually named by code, not prose) | 1,153 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1147** |
...
1158 rows: 1147 declared, 11 allowlisted. Generated by
