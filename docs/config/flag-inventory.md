...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,307 |
| exact string literals (i.e. actually named by code, not prose) | 1,232 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1226** |
...
1237 rows: 1226 declared, 11 allowlisted. Generated by
