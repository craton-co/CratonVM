...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,310 |
| exact string literals (i.e. actually named by code, not prose) | 1,235 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1229** |
...
1240 rows: 1229 declared, 11 allowlisted. Generated by
