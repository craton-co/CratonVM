...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,379 |
| exact string literals (i.e. actually named by code, not prose) | 1,304 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1298** |
...
1309 rows: 1298 declared, 11 allowlisted. Generated by
