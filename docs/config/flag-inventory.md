...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,390 |
| exact string literals (i.e. actually named by code, not prose) | 1,315 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1309** |
...
1320 rows: 1309 declared, 11 allowlisted. Generated by
