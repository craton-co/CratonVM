...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,384 |
| exact string literals (i.e. actually named by code, not prose) | 1,309 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1303** |
...
1314 rows: 1303 declared, 11 allowlisted. Generated by
