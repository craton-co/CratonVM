...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,263 |
| exact string literals (i.e. actually named by code, not prose) | 1,190 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1184** |
...
1195 rows: 1184 declared, 11 allowlisted. Generated by
