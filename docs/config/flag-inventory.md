...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,209 |
| exact string literals (i.e. actually named by code, not prose) | 1,140 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1133** |
...
1144 rows: 1133 declared, 11 allowlisted. Generated by
