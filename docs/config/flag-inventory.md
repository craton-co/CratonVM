...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,141 |
| exact string literals (i.e. actually named by code, not prose) | 1,073 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1067** |
...
1078 rows: 1067 declared, 11 allowlisted. Generated by
