...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,139 |
| exact string literals (i.e. actually named by code, not prose) | 1,071 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1065** |
...
1076 rows: 1065 declared, 11 allowlisted. Generated by
