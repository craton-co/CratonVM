...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,373 |
| exact string literals (i.e. actually named by code, not prose) | 1,298 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1292** |
...
1303 rows: 1292 declared, 11 allowlisted. Generated by
