...
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **894** |
...
905 rows: 894 declared, 11 allowlisted. Generated by
...
| `CRATONVM_DBG_CORRUPT_CELL` | DBG | `CRATONVM_DBG=corrupt-cell` | opt-in | off | diag | snapshot | vm |
