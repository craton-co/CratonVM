...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,418 |
| exact string literals (i.e. actually named by code, not prose) | 1,343 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1337** |
...
1348 rows: 1337 declared, 11 allowlisted. Generated by
