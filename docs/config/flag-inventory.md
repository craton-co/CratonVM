...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,072 |
| exact string literals (i.e. actually named by code, not prose) | 1,007 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1003** |
...
1014 rows: 1003 declared, 11 allowlisted. Generated by
