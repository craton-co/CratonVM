...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,331 |
| exact string literals (i.e. actually named by code, not prose) | 1,256 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1250** |
...
1261 rows: 1250 declared, 11 allowlisted. Generated by
