...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,369 |
| exact string literals (i.e. actually named by code, not prose) | 1,294 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1288** |
...
1299 rows: 1288 declared, 11 allowlisted. Generated by
