...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,080 |
| exact string literals (i.e. actually named by code, not prose) | 1,015 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1009** |
...
1020 rows: 1009 declared, 11 allowlisted. Generated by
