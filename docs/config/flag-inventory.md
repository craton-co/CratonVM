...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,326 |
| exact string literals (i.e. actually named by code, not prose) | 1,251 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1245** |
...
1256 rows: 1245 declared, 11 allowlisted. Generated by
