...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,222 |
| exact string literals (i.e. actually named by code, not prose) | 1,150 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1144** |
...
1155 rows: 1144 declared, 11 allowlisted. Generated by
