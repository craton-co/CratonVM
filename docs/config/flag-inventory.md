...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,158 |
| exact string literals (i.e. actually named by code, not prose) | 1,089 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1083** |
...
1094 rows: 1083 declared, 11 allowlisted. Generated by
