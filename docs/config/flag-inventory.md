...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,297 |
| exact string literals (i.e. actually named by code, not prose) | 1,222 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1216** |
...
1227 rows: 1216 declared, 11 allowlisted. Generated by
