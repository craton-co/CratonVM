...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,264 |
| exact string literals (i.e. actually named by code, not prose) | 1,191 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1185** |
...
1196 rows: 1185 declared, 11 allowlisted. Generated by
