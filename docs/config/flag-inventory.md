...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,413 |
| exact string literals (i.e. actually named by code, not prose) | 1,338 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1332** |
...
1343 rows: 1332 declared, 11 allowlisted. Generated by
