...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,255 |
| exact string literals (i.e. actually named by code, not prose) | 1,181 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1175** |
...
1186 rows: 1175 declared, 11 allowlisted. Generated by
