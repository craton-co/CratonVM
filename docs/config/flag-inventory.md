...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,124 |
| exact string literals (i.e. actually named by code, not prose) | 1,057 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1051** |
...
1062 rows: 1051 declared, 11 allowlisted. Generated by
