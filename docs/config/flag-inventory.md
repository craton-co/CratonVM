...
| exact string literals (i.e. actually named by code, not prose) | 1,067 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1061** |
...
1072 rows: 1061 declared, 11 allowlisted. Generated by
