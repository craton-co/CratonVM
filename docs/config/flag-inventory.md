...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,358 |
| exact string literals (i.e. actually named by code, not prose) | 1,283 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1277** |
...
1288 rows: 1277 declared, 11 allowlisted. Generated by
