...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,216 |
| exact string literals (i.e. actually named by code, not prose) | 1,145 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1139** |
...
1150 rows: 1139 declared, 11 allowlisted. Generated by
