...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,397 |
| exact string literals (i.e. actually named by code, not prose) | 1,322 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1316** |
...
1327 rows: 1316 declared, 11 allowlisted. Generated by
