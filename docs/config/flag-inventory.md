...
| exact string literals (i.e. actually named by code, not prose) | 1,162 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1156** |
...
1167 rows: 1156 declared, 11 allowlisted. Generated by
