...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,301 |
| exact string literals (i.e. actually named by code, not prose) | 1,226 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1220** |
...
1231 rows: 1220 declared, 11 allowlisted. Generated by
