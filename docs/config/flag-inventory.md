...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,131 |
| exact string literals (i.e. actually named by code, not prose) | 1,064 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1058** |
...
1069 rows: 1058 declared, 11 allowlisted. Generated by
