...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,087 |
| exact string literals (i.e. actually named by code, not prose) | 1,022 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1016** |
...
1027 rows: 1016 declared, 11 allowlisted. Generated by
