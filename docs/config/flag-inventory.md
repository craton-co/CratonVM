...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,306 |
| exact string literals (i.e. actually named by code, not prose) | 1,231 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1225** |
...
1236 rows: 1225 declared, 11 allowlisted. Generated by
