...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,409 |
| exact string literals (i.e. actually named by code, not prose) | 1,334 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1328** |
...
1339 rows: 1328 declared, 11 allowlisted. Generated by
