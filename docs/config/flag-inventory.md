...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,295 |
| exact string literals (i.e. actually named by code, not prose) | 1,220 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1214** |
...
1225 rows: 1214 declared, 11 allowlisted. Generated by
