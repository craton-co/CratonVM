...
|---|---|
<<<<<<< HEAD
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,392 |
| exact string literals (i.e. actually named by code, not prose) | 1,317 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1311** |
=======
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,391 |
| exact string literals (i.e. actually named by code, not prose) | 1,316 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1310** |
>>>>>>> origin/dev
...
<<<<<<< HEAD
1322 rows: 1311 declared, 11 allowlisted. Generated by
=======
1321 rows: 1310 declared, 11 allowlisted. Generated by
>>>>>>> origin/dev
