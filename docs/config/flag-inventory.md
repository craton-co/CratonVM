...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,202 |
| exact string literals (i.e. actually named by code, not prose) | 1,133 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1127** |
...
1138 rows: 1127 declared, 11 allowlisted. Generated by
