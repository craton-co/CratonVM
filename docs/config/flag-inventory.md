...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,289 |
| exact string literals (i.e. actually named by code, not prose) | 1,214 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1208** |
...
1219 rows: 1208 declared, 11 allowlisted. Generated by
