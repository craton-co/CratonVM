...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,396 |
| exact string literals (i.e. actually named by code, not prose) | 1,321 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1315** |
...
1326 rows: 1315 declared, 11 allowlisted. Generated by
