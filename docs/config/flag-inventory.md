...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,417 |
| exact string literals (i.e. actually named by code, not prose) | 1,342 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1336** |
...
1347 rows: 1336 declared, 11 allowlisted. Generated by
