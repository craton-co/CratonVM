...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,303 |
| exact string literals (i.e. actually named by code, not prose) | 1,228 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1222** |
...
1233 rows: 1222 declared, 11 allowlisted. Generated by
