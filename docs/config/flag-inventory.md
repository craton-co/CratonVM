...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,421 |
| exact string literals (i.e. actually named by code, not prose) | 1,346 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1339** |
...
1350 rows: 1339 declared, 11 allowlisted. Generated by
