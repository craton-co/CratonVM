...
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **929** |
...
940 rows: 929 declared, 11 allowlisted. Generated by
...
| `CRATONVM_DBG_WATCH_PUN` | DBG | `CRATONVM_DBG=watch-pun` | opt-in | off | diag | snapshot | gc |
