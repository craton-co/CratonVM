...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,233 |
| exact string literals (i.e. actually named by code, not prose) | 1,160 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1154** |
...
1165 rows: 1154 declared, 11 allowlisted. Generated by
