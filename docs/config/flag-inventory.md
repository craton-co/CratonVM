...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,126 |
| exact string literals (i.e. actually named by code, not prose) | 1,059 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1053** |
...
1064 rows: 1053 declared, 11 allowlisted. Generated by
