...
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **855** |
...
866 rows: 855 declared, 11 allowlisted. Generated by
...
| `CRATONVM_JIT_NO_OSR_FRAME_DEDUPE` | JIT | `CRATONVM_JIT=osr-frame-dedupe` | opt-out | on | behaviour | snapshot | jit |
