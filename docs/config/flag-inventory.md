...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,203 |
| exact string literals (i.e. actually named by code, not prose) | 1,134 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1128** |
...
1139 rows: 1128 declared, 11 allowlisted. Generated by
