...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,300 |
| exact string literals (i.e. actually named by code, not prose) | 1,225 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1219** |
...
1230 rows: 1219 declared, 11 allowlisted. Generated by
