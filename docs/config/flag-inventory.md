...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,426 |
| exact string literals (i.e. actually named by code, not prose) | 1,351 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1345** |
...
1356 rows: 1345 declared, 11 allowlisted. Generated by
