...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,556 |
| exact string literals (i.e. actually named by code, not prose) | 1,473 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1463** |
...
1474 rows: 1463 declared, 11 allowlisted. Generated by
