...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,278 |
| exact string literals (i.e. actually named by code, not prose) | 1,204 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1198** |
...
1209 rows: 1198 declared, 11 allowlisted. Generated by
