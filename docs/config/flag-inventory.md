...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,286 |
| exact string literals (i.e. actually named by code, not prose) | 1,211 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1205** |
...
1216 rows: 1205 declared, 11 allowlisted. Generated by
