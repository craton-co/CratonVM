...
| exact string literals (i.e. actually named by code, not prose) | 1,178 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1172** |
...
1183 rows: 1172 declared, 11 allowlisted. Generated by
