...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,424 |
| exact string literals (i.e. actually named by code, not prose) | 1,349 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1342** |
...
1353 rows: 1342 declared, 11 allowlisted. Generated by
