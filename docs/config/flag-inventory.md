...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,425 |
| exact string literals (i.e. actually named by code, not prose) | 1,350 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1344** |
...
1355 rows: 1344 declared, 11 allowlisted. Generated by
