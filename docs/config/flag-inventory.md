...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,366 |
| exact string literals (i.e. actually named by code, not prose) | 1,291 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1285** |
...
1296 rows: 1285 declared, 11 allowlisted. Generated by
