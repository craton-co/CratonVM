...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,415 |
| exact string literals (i.e. actually named by code, not prose) | 1,340 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1334** |
...
1345 rows: 1334 declared, 11 allowlisted. Generated by
