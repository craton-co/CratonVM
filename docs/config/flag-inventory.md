...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,299 |
| exact string literals (i.e. actually named by code, not prose) | 1,224 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1218** |
...
1229 rows: 1218 declared, 11 allowlisted. Generated by
