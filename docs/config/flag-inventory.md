...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,398 |
| exact string literals (i.e. actually named by code, not prose) | 1,323 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1317** |
...
1328 rows: 1317 declared, 11 allowlisted. Generated by
