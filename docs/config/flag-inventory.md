...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,329 |
| exact string literals (i.e. actually named by code, not prose) | 1,254 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1248** |
...
1259 rows: 1248 declared, 11 allowlisted. Generated by
