...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,245 |
| exact string literals (i.e. actually named by code, not prose) | 1,171 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1165** |
...
1176 rows: 1165 declared, 11 allowlisted. Generated by
