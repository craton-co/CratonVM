...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,167 |
| exact string literals (i.e. actually named by code, not prose) | 1,099 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1093** |
...
1104 rows: 1093 declared, 11 allowlisted. Generated by
