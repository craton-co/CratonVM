...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,119 |
| exact string literals (i.e. actually named by code, not prose) | 1,052 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1046** |
...
1057 rows: 1046 declared, 11 allowlisted. Generated by
