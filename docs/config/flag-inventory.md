...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,159 |
| exact string literals (i.e. actually named by code, not prose) | 1,091 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1085** |
...
1096 rows: 1085 declared, 11 allowlisted. Generated by
