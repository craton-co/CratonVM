...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,240 |
| exact string literals (i.e. actually named by code, not prose) | 1,166 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1160** |
...
1171 rows: 1160 declared, 11 allowlisted. Generated by
