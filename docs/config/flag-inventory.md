...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,218 |
| exact string literals (i.e. actually named by code, not prose) | 1,147 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1141** |
...
1152 rows: 1141 declared, 11 allowlisted. Generated by
