...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,128 |
| exact string literals (i.e. actually named by code, not prose) | 1,061 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1055** |
...
1066 rows: 1055 declared, 11 allowlisted. Generated by
