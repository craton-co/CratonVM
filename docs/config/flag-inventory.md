...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,262 |
| exact string literals (i.e. actually named by code, not prose) | 1,189 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1183** |
...
1194 rows: 1183 declared, 11 allowlisted. Generated by
