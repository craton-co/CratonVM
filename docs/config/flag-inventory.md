...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,204 |
| exact string literals (i.e. actually named by code, not prose) | 1,135 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1129** |
...
1140 rows: 1129 declared, 11 allowlisted. Generated by
