...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,277 |
| exact string literals (i.e. actually named by code, not prose) | 1,203 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1197** |
...
1208 rows: 1197 declared, 11 allowlisted. Generated by
