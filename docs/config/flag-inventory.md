...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,285 |
| exact string literals (i.e. actually named by code, not prose) | 1,210 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1204** |
...
1215 rows: 1204 declared, 11 allowlisted. Generated by
