...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,434 |
| exact string literals (i.e. actually named by code, not prose) | 1,359 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1351** |
...
1362 rows: 1351 declared, 11 allowlisted. Generated by
