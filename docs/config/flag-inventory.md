...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,364 |
| exact string literals (i.e. actually named by code, not prose) | 1,289 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1283** |
...
1294 rows: 1283 declared, 11 allowlisted. Generated by
