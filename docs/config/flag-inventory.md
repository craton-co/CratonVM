...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,127 |
| exact string literals (i.e. actually named by code, not prose) | 1,060 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1054** |
...
1065 rows: 1054 declared, 11 allowlisted. Generated by
