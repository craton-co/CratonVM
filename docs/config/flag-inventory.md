...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,325 |
| exact string literals (i.e. actually named by code, not prose) | 1,250 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1244** |
...
1255 rows: 1244 declared, 11 allowlisted. Generated by
