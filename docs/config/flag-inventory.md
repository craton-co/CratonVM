...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,292 |
| exact string literals (i.e. actually named by code, not prose) | 1,217 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1211** |
...
1222 rows: 1211 declared, 11 allowlisted. Generated by
