...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,193 |
| exact string literals (i.e. actually named by code, not prose) | 1,124 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1118** |
...
1129 rows: 1118 declared, 11 allowlisted. Generated by
