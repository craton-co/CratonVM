...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,258 |
| exact string literals (i.e. actually named by code, not prose) | 1,185 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1179** |
...
1190 rows: 1179 declared, 11 allowlisted. Generated by
