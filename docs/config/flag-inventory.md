...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,290 |
| exact string literals (i.e. actually named by code, not prose) | 1,215 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1209** |
...
1220 rows: 1209 declared, 11 allowlisted. Generated by
