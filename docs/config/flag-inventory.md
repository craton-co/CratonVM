...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,284 |
| exact string literals (i.e. actually named by code, not prose) | 1,209 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1203** |
...
1214 rows: 1203 declared, 11 allowlisted. Generated by
