...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,205 |
| exact string literals (i.e. actually named by code, not prose) | 1,136 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1130** |
...
1141 rows: 1130 declared, 11 allowlisted. Generated by
