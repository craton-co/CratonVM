...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,088 |
| exact string literals (i.e. actually named by code, not prose) | 1,021 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1015** |
...
1026 rows: 1015 declared, 11 allowlisted. Generated by
