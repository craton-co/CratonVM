...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,243 |
| exact string literals (i.e. actually named by code, not prose) | 1,169 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1163** |
...
1174 rows: 1163 declared, 11 allowlisted. Generated by
