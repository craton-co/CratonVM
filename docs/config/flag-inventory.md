...
| exact string literals (i.e. actually named by code, not prose) | 1,174 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1168** |
...
1179 rows: 1168 declared, 11 allowlisted. Generated by
