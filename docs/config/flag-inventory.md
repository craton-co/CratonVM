...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,402 |
| exact string literals (i.e. actually named by code, not prose) | 1,327 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1321** |
...
1332 rows: 1321 declared, 11 allowlisted. Generated by
