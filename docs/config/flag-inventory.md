...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,217 |
| exact string literals (i.e. actually named by code, not prose) | 1,146 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1140** |
...
1151 rows: 1140 declared, 11 allowlisted. Generated by
