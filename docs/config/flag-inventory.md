...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,431 |
| exact string literals (i.e. actually named by code, not prose) | 1,356 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1350** |
...
1361 rows: 1350 declared, 11 allowlisted. Generated by
...
| `CRATONVM_DBG_GC_STRESS` | DBG | `CRATONVM_DBG=gc-stress` | opt-in | off | diag | snapshot | difftest, types |
...
| `CRATONVM_DBG_VERIFY_OOP_MAPS` | DBG | `CRATONVM_DBG=verify-oop-maps` | opt-in | off | diag | snapshot | classloading, vm |
...
| `CRATONVM_G1_JIT_MARK_DRIVER` | GC | `CRATONVM_GC=g1-jit-mark-driver` | opt-in | off | behaviour | snapshot | vm |
...
| `CRATONVM_GC_LAYOUT_SCAN_CACHE` | GC | `CRATONVM_GC=layout-scan-cache` | opt-in | off | behaviour | snapshot | types |
...
| `CRATONVM_GC_NO_PEER_PIN_DIVERT` | GC | `CRATONVM_GC=peer-pin-divert` | opt-out | on | behaviour | snapshot | gc |
...
| `CRATONVM_JIT_ARM64` | JIT | `CRATONVM_JIT=arm64` | opt-in | off | behaviour | snapshot | jit |
...
| `CRATONVM_JIT_CHECKCAST_INLINE` | JIT | `CRATONVM_JIT=checkcast-inline` | opt-in | off | behaviour | snapshot | jit |
...
| `CRATONVM_JIT_FINAL_DEVIRT` | JIT | `CRATONVM_JIT=final-devirt` | opt-in | off | behaviour | snapshot | vm |
| `CRATONVM_JIT_FINAL_DEVIRT_NATIVE_SCREEN` | JIT | `CRATONVM_JIT=final-devirt-native-screen` | opt-in | off | behaviour | snapshot | vm |
...
| `CRATONVM_JIT_IR_AASTORE` | JIT | `CRATONVM_JIT=ir-aastore` | opt-in | off | behaviour | snapshot | jit |
...
| `CRATONVM_JIT_IR_BCE_RANGE` | JIT | `CRATONVM_JIT=ir-bce-range` | opt-in | off | behaviour | snapshot | jit |
...
| `CRATONVM_JIT_IR_CHECK_ELIM` | JIT | `CRATONVM_JIT=ir-check-elim` | opt-in | off | behaviour | snapshot | jit |
...
| `CRATONVM_JIT_IR_DROP_UNREACHABLE_HOMES` | JIT | `CRATONVM_JIT=ir-drop-unreachable-homes` | default-on | on | behaviour | snapshot | jit |
...
| `CRATONVM_JIT_IR_HOT_LAYOUT` | JIT | `CRATONVM_JIT=ir-hot-layout` | opt-in | off | behaviour | snapshot | jit |
...
| `CRATONVM_JIT_IR_LICM_HOIST_COUNTED` | JIT | `CRATONVM_JIT=ir-licm-hoist-counted` | opt-in | off | behaviour | snapshot | jit |
...
| `CRATONVM_JIT_IR_LIST_SCHED` | JIT | `CRATONVM_JIT=ir-list-sched` | opt-in | off | behaviour | snapshot | jit |
| `CRATONVM_JIT_IR_LOAD_CSE` | JIT | `CRATONVM_JIT=ir-load-cse` | opt-in | off | behaviour | snapshot | jit |
| `CRATONVM_JIT_IR_LOAD_CSE_ALIAS` | JIT | `CRATONVM_JIT=ir-load-cse-alias` | opt-in | off | behaviour | snapshot | jit |
...
| `CRATONVM_JIT_IR_POLL_OUTLINE` | JIT | `CRATONVM_JIT=ir-poll-outline` | opt-in | off | behaviour | snapshot | jit |
...
| `CRATONVM_JIT_IR_SITE_TRAP` | JIT | `CRATONVM_JIT=ir-site-trap` | opt-in | off | behaviour | snapshot | jit |
...
| `CRATONVM_JIT_IR_TRAP_REPLAY_GUARD` | JIT | `CRATONVM_JIT=ir-trap-replay-guard` | opt-in | off | behaviour | snapshot | jit |
...
| `CRATONVM_JIT_IR_UNROLL_UNREACHABLE_FRAMES` | JIT | `CRATONVM_JIT=ir-unroll-unreachable-frames` | opt-in | off | behaviour | snapshot | jit |
...
| `CRATONVM_JIT_LAYOUT_EPOCH_STATIC` | JIT | `CRATONVM_JIT=layout-epoch-static` | opt-in | off | behaviour | snapshot | types |
...
| `CRATONVM_JIT_POST_TLAB_HASH_STAMP` | JIT | `CRATONVM_JIT=post-tlab-hash-stamp` | opt-in | off | behaviour | snapshot | vm |
...
| `CRATONVM_MONITOR_FASTPATH` | THREADS | `CRATONVM_THREADS=monitor-fastpath` | default-on | on | behaviour | snapshot | vm |
...
| `CRATONVM_TIER_PGO_C2_WINDOW` | JIT | `CRATONVM_JIT=tier-pgo-c2-window` | opt-in | off | behaviour | snapshot | jit |
