...
| exact string literals (i.e. actually named by code, not prose) | 1,056 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1050** |
...
1061 rows: 1050 declared, 11 allowlisted. Generated by
