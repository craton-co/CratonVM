...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,395 |
| exact string literals (i.e. actually named by code, not prose) | 1,320 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1314** |
...
1325 rows: 1314 declared, 11 allowlisted. Generated by
