...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,261 |
| exact string literals (i.e. actually named by code, not prose) | 1,188 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1182** |
...
1193 rows: 1182 declared, 11 allowlisted. Generated by
