...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,378 |
| exact string literals (i.e. actually named by code, not prose) | 1,303 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1297** |
...
1308 rows: 1297 declared, 11 allowlisted. Generated by
