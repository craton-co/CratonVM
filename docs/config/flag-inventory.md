...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,393 |
| exact string literals (i.e. actually named by code, not prose) | 1,318 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1312** |
...
1323 rows: 1312 declared, 11 allowlisted. Generated by
