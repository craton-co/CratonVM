...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,143 |
| exact string literals (i.e. actually named by code, not prose) | 1,075 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1069** |
...
1080 rows: 1069 declared, 11 allowlisted. Generated by
