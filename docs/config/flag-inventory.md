...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,293 |
| exact string literals (i.e. actually named by code, not prose) | 1,218 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1212** |
...
1223 rows: 1212 declared, 11 allowlisted. Generated by
