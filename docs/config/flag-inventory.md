...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,388 |
| exact string literals (i.e. actually named by code, not prose) | 1,313 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1307** |
...
1318 rows: 1307 declared, 11 allowlisted. Generated by
