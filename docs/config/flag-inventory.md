...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,302 |
| exact string literals (i.e. actually named by code, not prose) | 1,227 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1221** |
...
1232 rows: 1221 declared, 11 allowlisted. Generated by
