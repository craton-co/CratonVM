...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,091 |
| exact string literals (i.e. actually named by code, not prose) | 1,024 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1019** |
