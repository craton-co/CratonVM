...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,401 |
| exact string literals (i.e. actually named by code, not prose) | 1,326 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1320** |
...
1331 rows: 1320 declared, 11 allowlisted. Generated by
