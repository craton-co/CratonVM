...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,372 |
| exact string literals (i.e. actually named by code, not prose) | 1,297 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1291** |
...
1302 rows: 1291 declared, 11 allowlisted. Generated by
