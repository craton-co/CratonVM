...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,330 |
| exact string literals (i.e. actually named by code, not prose) | 1,255 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1249** |
...
1260 rows: 1249 declared, 11 allowlisted. Generated by
