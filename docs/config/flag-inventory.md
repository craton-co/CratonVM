...
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **879** |
...
890 rows: 879 declared, 11 allowlisted. Generated by
...
| `CRATONVM_CF_DELEGATING_YIELD` | LOADER | `CRATONVM_LOADER=cf-delegating-yield` | default-on | on | behaviour | snapshot | vm |
