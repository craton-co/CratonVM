...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,294 |
| exact string literals (i.e. actually named by code, not prose) | 1,219 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1213** |
...
1224 rows: 1213 declared, 11 allowlisted. Generated by
