...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,176 |
| exact string literals (i.e. actually named by code, not prose) | 1,107 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1101** |
...
1112 rows: 1101 declared, 11 allowlisted. Generated by
