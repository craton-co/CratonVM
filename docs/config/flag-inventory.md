...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,191 |
| exact string literals (i.e. actually named by code, not prose) | 1,122 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1116** |
...
1127 rows: 1116 declared, 11 allowlisted. Generated by
