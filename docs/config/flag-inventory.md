...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,387 |
| exact string literals (i.e. actually named by code, not prose) | 1,312 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1306** |
...
1317 rows: 1306 declared, 11 allowlisted. Generated by
