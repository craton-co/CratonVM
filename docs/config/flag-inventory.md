...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,404 |
| exact string literals (i.e. actually named by code, not prose) | 1,329 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1323** |
...
1334 rows: 1323 declared, 11 allowlisted. Generated by
