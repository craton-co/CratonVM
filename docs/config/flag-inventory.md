...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,308 |
| exact string literals (i.e. actually named by code, not prose) | 1,233 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1227** |
...
1238 rows: 1227 declared, 11 allowlisted. Generated by
