...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,304 |
| exact string literals (i.e. actually named by code, not prose) | 1,229 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1223** |
...
1234 rows: 1223 declared, 11 allowlisted. Generated by
