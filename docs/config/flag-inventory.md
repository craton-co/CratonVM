...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,271 |
| exact string literals (i.e. actually named by code, not prose) | 1,197 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1191** |
...
1202 rows: 1191 declared, 11 allowlisted. Generated by
