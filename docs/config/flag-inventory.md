...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,405 |
| exact string literals (i.e. actually named by code, not prose) | 1,330 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1324** |
...
1335 rows: 1324 declared, 11 allowlisted. Generated by
