...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,385 |
| exact string literals (i.e. actually named by code, not prose) | 1,310 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1304** |
...
1315 rows: 1304 declared, 11 allowlisted. Generated by
