...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,220 |
| exact string literals (i.e. actually named by code, not prose) | 1,148 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1142** |
...
1153 rows: 1142 declared, 11 allowlisted. Generated by
