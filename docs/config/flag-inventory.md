...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,132 |
| exact string literals (i.e. actually named by code, not prose) | 1,065 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1059** |
...
1070 rows: 1059 declared, 11 allowlisted. Generated by
...
| `CRATONVM_G1_CARD_CLEAN` | GC | `CRATONVM_GC=g1-card-clean` | opt-in | off | behaviour | snapshot | types |
