...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,149 |
| exact string literals (i.e. actually named by code, not prose) | 1,081 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1075** |
...
1086 rows: 1075 declared, 11 allowlisted. Generated by
