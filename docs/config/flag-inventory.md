...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,416 |
| exact string literals (i.e. actually named by code, not prose) | 1,341 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1335** |
...
1346 rows: 1335 declared, 11 allowlisted. Generated by
