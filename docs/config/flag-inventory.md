...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,309 |
| exact string literals (i.e. actually named by code, not prose) | 1,234 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1228** |
...
1239 rows: 1228 declared, 11 allowlisted. Generated by
