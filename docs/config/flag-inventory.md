...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,374 |
| exact string literals (i.e. actually named by code, not prose) | 1,299 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1293** |
...
1304 rows: 1293 declared, 11 allowlisted. Generated by
