...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,165 |
| exact string literals (i.e. actually named by code, not prose) | 1,097 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1091** |
...
1102 rows: 1091 declared, 11 allowlisted. Generated by
