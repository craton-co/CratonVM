...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,355 |
| exact string literals (i.e. actually named by code, not prose) | 1,280 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1274** |
...
1285 rows: 1274 declared, 11 allowlisted. Generated by
