...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,197 |
| exact string literals (i.e. actually named by code, not prose) | 1,128 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1122** |
...
1133 rows: 1122 declared, 11 allowlisted. Generated by
