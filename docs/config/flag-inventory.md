...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,160 |
| exact string literals (i.e. actually named by code, not prose) | 1,092 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1086** |
...
1097 rows: 1086 declared, 11 allowlisted. Generated by
