...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,185 |
| exact string literals (i.e. actually named by code, not prose) | 1,116 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1110** |
...
1121 rows: 1110 declared, 11 allowlisted. Generated by
