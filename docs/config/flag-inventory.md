...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,192 |
| exact string literals (i.e. actually named by code, not prose) | 1,123 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1117** |
...
1128 rows: 1117 declared, 11 allowlisted. Generated by
