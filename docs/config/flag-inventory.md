...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,137 |
| exact string literals (i.e. actually named by code, not prose) | 1,069 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1063** |
...
1074 rows: 1063 declared, 11 allowlisted. Generated by
