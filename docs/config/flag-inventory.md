...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,151 |
| exact string literals (i.e. actually named by code, not prose) | 1,083 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1077** |
...
1088 rows: 1077 declared, 11 allowlisted. Generated by
