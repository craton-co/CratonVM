...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,242 |
| exact string literals (i.e. actually named by code, not prose) | 1,168 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1162** |
...
1173 rows: 1162 declared, 11 allowlisted. Generated by
...
| `CRATONVM_G1_HUMONGOUS_MARKS` | GC | `CRATONVM_GC=g1-humongous-marks` | opt-in | off | behaviour | snapshot | types |
