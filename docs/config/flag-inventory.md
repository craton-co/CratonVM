...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,121 |
| exact string literals (i.e. actually named by code, not prose) | 1,054 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1048** |
...
1059 rows: 1048 declared, 11 allowlisted. Generated by
