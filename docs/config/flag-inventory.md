...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,336 |
| exact string literals (i.e. actually named by code, not prose) | 1,261 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1255** |
...
1266 rows: 1255 declared, 11 allowlisted. Generated by
