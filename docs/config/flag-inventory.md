...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,399 |
| exact string literals (i.e. actually named by code, not prose) | 1,324 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1318** |
...
1329 rows: 1318 declared, 11 allowlisted. Generated by
