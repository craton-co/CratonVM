...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,406 |
| exact string literals (i.e. actually named by code, not prose) | 1,331 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1325** |
...
1336 rows: 1325 declared, 11 allowlisted. Generated by
