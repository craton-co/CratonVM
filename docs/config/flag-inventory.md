...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,200 |
| exact string literals (i.e. actually named by code, not prose) | 1,131 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1125** |
...
1136 rows: 1125 declared, 11 allowlisted. Generated by
