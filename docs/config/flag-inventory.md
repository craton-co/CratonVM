...
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **689** |
...
700 rows: 689 declared, 11 allowlisted. Generated by
...
| `CRATONVM_DBG_IR_ISEL` | DBG | `CRATONVM_DBG=ir-isel` | opt-in | off | diag | snapshot | jit |
