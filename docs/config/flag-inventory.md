...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,129 |
| exact string literals (i.e. actually named by code, not prose) | 1,062 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1056** |
...
1067 rows: 1056 declared, 11 allowlisted. Generated by
