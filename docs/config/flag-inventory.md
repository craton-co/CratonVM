...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,125 |
| exact string literals (i.e. actually named by code, not prose) | 1,058 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1052** |
...
1063 rows: 1052 declared, 11 allowlisted. Generated by
