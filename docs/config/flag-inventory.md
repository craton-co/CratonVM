...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,270 |
| exact string literals (i.e. actually named by code, not prose) | 1,196 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1190** |
...
1201 rows: 1190 declared, 11 allowlisted. Generated by
