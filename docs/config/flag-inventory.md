...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,363 |
| exact string literals (i.e. actually named by code, not prose) | 1,288 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1282** |
...
1293 rows: 1282 declared, 11 allowlisted. Generated by
