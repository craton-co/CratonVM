...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,206 |
| exact string literals (i.e. actually named by code, not prose) | 1,137 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1131** |
...
1142 rows: 1131 declared, 11 allowlisted. Generated by
