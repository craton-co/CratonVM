...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,375 |
| exact string literals (i.e. actually named by code, not prose) | 1,300 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1294** |
...
1305 rows: 1294 declared, 11 allowlisted. Generated by
