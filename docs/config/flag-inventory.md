...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,241 |
| exact string literals (i.e. actually named by code, not prose) | 1,167 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1161** |
...
1172 rows: 1161 declared, 11 allowlisted. Generated by
