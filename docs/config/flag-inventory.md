...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,321 |
| exact string literals (i.e. actually named by code, not prose) | 1,246 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1240** |
...
1251 rows: 1240 declared, 11 allowlisted. Generated by
