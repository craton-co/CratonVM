...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,394 |
| exact string literals (i.e. actually named by code, not prose) | 1,319 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1313** |
...
1324 rows: 1313 declared, 11 allowlisted. Generated by
