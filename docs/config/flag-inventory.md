...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,198 |
| exact string literals (i.e. actually named by code, not prose) | 1,129 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1123** |
...
1134 rows: 1123 declared, 11 allowlisted. Generated by
