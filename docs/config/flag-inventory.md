...
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **824** |
...
835 rows: 824 declared, 11 allowlisted. Generated by
...
| `CRATONVM_G1_YOUNG_PAUSE_TARGET` | GC | `CRATONVM_GC=g1-young-pause-target` | default-on | on | behaviour | snapshot | types |
...
| `CRATONVM_NATIVE_SHADOW_SINK_CAP` | DBG | `CRATONVM_DBG=native-shadow-sink-cap` | opt-in | off | diag | snapshot | vm |
