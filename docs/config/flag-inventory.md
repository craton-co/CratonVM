...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,275 |
| exact string literals (i.e. actually named by code, not prose) | 1,201 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1195** |
...
1206 rows: 1195 declared, 11 allowlisted. Generated by
