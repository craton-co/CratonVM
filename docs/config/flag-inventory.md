...
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **834** |
...
845 rows: 834 declared, 11 allowlisted. Generated by
...
| `CRATONVM_NO_MISPLACED_FLAG_WARNING` | DBG | `CRATONVM_DBG=misplaced-flag-warning` | opt-out | on | diag | snapshot | vm-cli |
