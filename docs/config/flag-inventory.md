...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,239 |
| exact string literals (i.e. actually named by code, not prose) | 1,165 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1159** |
...
1170 rows: 1159 declared, 11 allowlisted. Generated by
