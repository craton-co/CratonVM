...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,419 |
| exact string literals (i.e. actually named by code, not prose) | 1,344 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1338** |
...
1349 rows: 1338 declared, 11 allowlisted. Generated by
