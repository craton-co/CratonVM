...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,180 |
| exact string literals (i.e. actually named by code, not prose) | 1,111 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1105** |
...
1116 rows: 1105 declared, 11 allowlisted. Generated by
