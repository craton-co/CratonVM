...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,224 |
| exact string literals (i.e. actually named by code, not prose) | 1,151 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1145** |
...
1156 rows: 1145 declared, 11 allowlisted. Generated by
