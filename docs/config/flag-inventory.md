...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,376 |
| exact string literals (i.e. actually named by code, not prose) | 1,301 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1295** |
...
1306 rows: 1295 declared, 11 allowlisted. Generated by
