...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,188 |
| exact string literals (i.e. actually named by code, not prose) | 1,119 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1113** |
...
1124 rows: 1113 declared, 11 allowlisted. Generated by
