...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,337 |
| exact string literals (i.e. actually named by code, not prose) | 1,262 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1256** |
...
1267 rows: 1256 declared, 11 allowlisted. Generated by
