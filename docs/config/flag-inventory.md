...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,332 |
| exact string literals (i.e. actually named by code, not prose) | 1,257 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1251** |
...
1262 rows: 1251 declared, 11 allowlisted. Generated by
