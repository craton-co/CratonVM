...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,162 |
| exact string literals (i.e. actually named by code, not prose) | 1,094 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1088** |
...
1099 rows: 1088 declared, 11 allowlisted. Generated by
