...
|---|---|
<<<<<<< HEAD
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,145 |
| exact string literals (i.e. actually named by code, not prose) | 1,077 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1071** |
=======
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,164 |
| exact string literals (i.e. actually named by code, not prose) | 1,096 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1090** |
>>>>>>> origin/dev
...
<<<<<<< HEAD
1082 rows: 1071 declared, 11 allowlisted. Generated by
=======
1101 rows: 1090 declared, 11 allowlisted. Generated by
>>>>>>> origin/dev
