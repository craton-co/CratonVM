...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,361 |
| exact string literals (i.e. actually named by code, not prose) | 1,286 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1280** |
...
1291 rows: 1280 declared, 11 allowlisted. Generated by
