...
| | count |
|---|---|
| distinct `CRATONVM_*` identifiers appearing anywhere in Rust source | 1,296 |
| exact string literals (i.e. actually named by code, not prose) | 1,221 |
| **declared** in `flag_groups::INVENTORY` + scalars + group variables | **1215** |
...
1226 rows: 1215 declared, 11 allowlisted. Generated by
