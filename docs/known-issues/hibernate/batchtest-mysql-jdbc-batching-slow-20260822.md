...
## Status
**OPEN** (2026-08-22). Confirmed via direct HotSpot A/B on the identical MySQL
setup — a real, new, MySQL-specific CratonVM performance gap, not a
correctness bug, not a test-config artifact.
