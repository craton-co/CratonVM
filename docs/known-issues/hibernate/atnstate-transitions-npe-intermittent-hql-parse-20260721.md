...
| | |
|---|---|
| **Status** | 🟡 OPEN — genuine, CratonVM-specific, but **intermittent/non-deterministic** (not a clean 100%-repro bug). Root cause not pinned; a strong circumstantial suspect area is identified below. |
