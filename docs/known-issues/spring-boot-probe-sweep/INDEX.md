...
| [SBR-03](../../internal/fixed-suite-bugs/SBR-03-array-interface-instanceof.md) | `Object[] instanceof I[]` returns `true` (HS `false`) | DIFF/correctness | ArrInstProbe | ✅ **FIXED** dev `a245002c` |
...
| [SBR-06](../../internal/fixed-suite-bugs/SBR-06-field-getgenerictype-raw.md) | Constructor `Parameter.getParameterizedType()` erases generics → raw `Class` | DIFF | GenProbe | ✅ **FIXED** dev `bce39db7` |
| [SBR-07](SBR-07-getsimplename-nested.md) | `getSimpleName()` on nested class returns `Outer$Inner` | DIFF | KProtoProbe | **FIX** |
...
| [SBR-13](SBR-13-protectiondomain-classloader-permissions.md) | `getProtectionDomain()`: classloader=`Object`, permissions `null` | DIFF | InstProbe | FIX |
