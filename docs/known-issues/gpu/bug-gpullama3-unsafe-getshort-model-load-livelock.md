...
## Severity
**HIGH** — CratonVM never completes model load for this real-world app; the process
must be force-killed. Not a slowness/perf gap — CPU time is actively being burned
