...
`docs/known-issues/gpu-offload-followups-20260711.md`, which has moved into the
internal tree under `fixed-suite-bugs/` and so is stripped from public history —
