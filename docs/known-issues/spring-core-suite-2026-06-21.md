...
| [env-classreading](SC-env-classreading.md) | high | high | FIX+HO | 6 | getenv/getProperties identity [open,FIX]; `Object.equals` shadows override (precedenceOf=-1) [open,HO]; ~~`int.class`→Integer~~ **✅fixed on dev**; custom-ClassLoader `getResourceAsStream`=null [open,HO] — triaged 2026-06-22, see doc |
