...
| [task-retry-util-misc](../internal/spring/SC-task-retry-util-misc.md) | med | med-high | MIXED | 14 | ~~non-Serializable unmod-map~~ fixed; ~~Properties.store missing #date~~ fixed; Throwable deser; retry 20ms timing; **ByteBuddy ClassInjector [handoff]**; AQS throttle |
