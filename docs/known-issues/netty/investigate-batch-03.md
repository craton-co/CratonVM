...
|---|---|---|
| `io.netty.buffer.ReadOnlyDirectByteBufferBufTest` | FAIL | default=FAIL, g1=FAIL, zgc=FAIL |
| `io.netty.buffer.ReadOnlyUnsafeDirectByteBufferBufTest` | FAIL | default=FAIL, g1=FAIL, zgc=FAIL |
| `io.netty.buffer.RetainedDuplicatedByteBufTest` | FAIL/HANG | default=FAIL, g1=HANG, zgc=FAIL |
| `io.netty.buffer.RetainedSlicedByteBufTest` | FAIL | default=FAIL, g1=FAIL, zgc=FAIL |
| `io.netty.buffer.SimpleLeakAwareByteBufTest` | HANG | default=HANG, g1=HANG, zgc=HANG |
| `io.netty.buffer.SimpleLeakAwareCompositeByteBufTest` | HANG | default=HANG, g1=HANG, zgc=HANG |
| `io.netty.buffer.SizeClassedChunkCacheTest` | FAIL | default=FAIL, g1=FAIL, zgc=FAIL |
| `io.netty.buffer.SlicedByteBufTest` | FAIL | default=FAIL, g1=FAIL, zgc=FAIL |
| `io.netty.buffer.WrappedCompositeByteBufTest` | HANG | default=HANG, g1=HANG, zgc=HANG |
| `io.netty.buffer.search.SearchProcessorTest` | HANG | default=HANG, g1=HANG, zgc=HANG |
| `io.netty.channel.AbstractChannelTest` | FAIL | default=FAIL, g1=FAIL, zgc=FAIL |
| `io.netty.channel.AdaptiveRecvByteBufAllocatorTest` | FAIL | default=FAIL, g1=FAIL, zgc=FAIL |
| `io.netty.channel.ChannelInitializerTest` | FAIL | default=FAIL, g1=FAIL, zgc=FAIL |
| `io.netty.channel.DelegatingChannelPromiseNotifierTest` | FAIL | default=FAIL, g1=FAIL, zgc=FAIL |
| `io.netty.channel.ManualIoEventLoopTest` | FAIL | default=FAIL, g1=FAIL, zgc=FAIL |
