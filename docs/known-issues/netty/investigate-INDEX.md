...
- [batch 07](investigate-batch-07.md) — 15 classes (io.netty.handler.codec.http2.DefaultHttp2FrameWriterTest .. io.netty.handler.codec.http2.Http2MultiplexCodecTest)
