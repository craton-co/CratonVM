...
Arrived here from
[`gc-moving-young-persistent-nonmoving-fallback-regression`](../../internal/fixed-suite-bugs/tomcat/gc-moving-young-persistent-nonmoving-fallback-regression-CLOSED.md),
