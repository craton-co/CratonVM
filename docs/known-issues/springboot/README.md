...
- The `Class.getMethods()` override-shadowing cluster and the Jooq timeout closure are **FIXED**: [`class-getmethods-override-shadowing-duplicate-close-cluster-FIXED.md`](../../internal/springboot/class-getmethods-override-shadowing-duplicate-close-cluster-FIXED.md) and [`jooq-destroy-method-ambiguity-and-hang-FIXED.md`](../../internal/springboot/jooq-destroy-method-ambiguity-and-hang-FIXED.md) record the evidence.
