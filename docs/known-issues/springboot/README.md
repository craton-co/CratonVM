...
| [`jetty-webserver-factory-poststartup-timeout-and-reflective-supertype-residuals.md`](jetty-webserver-factory-poststartup-timeout-and-reflective-supertype-residuals.md) | PARTIALLY FIXED — reflective-supertype residual fixed 2026-07-18; two factory post-startup timeouts remain OPEN |
