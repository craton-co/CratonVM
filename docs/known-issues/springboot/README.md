...
| [`jetty-webserver-factory-poststartup-timeout-and-reflective-supertype-residuals.md`](jetty-webserver-factory-poststartup-timeout-and-reflective-supertype-residuals.md) | PARTIALLY FIXED — reflective-supertype residual + 3 real bugs (deflate SYNC_FLUSH, wildcard connect target, deflate-after-finish corruption) fixed 2026-07-18; one factory-timeout mystery remains OPEN (deterministic `Deflater.end()` monitorenter hang, root cause not yet found) |
