...
| [`cacheautoconfigurationtests-hazelcast-httprequest-abstractmethoderror.md`](cacheautoconfigurationtests-hazelcast-httprequest-abstractmethoderror.md) | OPEN — found 2026-07-19, unrelated residual surfaced while verifying the Infinispan row above |
...
| [`embedded-tomcat-loopback-self-connect-silent-hang-20260719.md`](embedded-tomcat-loopback-self-connect-silent-hang-20260719.md) | **OPEN — found 2026-07-19**, current `dev` tip. Embedded-Tomcat self-connect tests hang indefinitely (no timeout, no error) instead of completing; likely a severe worsening of the `webclient-loopback-self-connect-timeout-os10060-cluster` family, found while reverifying an unrelated fix against a fresh `dev` merge |
