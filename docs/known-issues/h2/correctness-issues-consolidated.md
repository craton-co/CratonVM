...
| `org.h2.test.store.TestMVStoreTool` | FAIL, 1:33, `OutOfMemoryError` | the ZGC fragmentation defect, four repairs on 2026-08-29 — see `../../internal/fixed-suite-bugs/h2-suite-bugs/bug-h2-testkillprocess-zgc-oom-at-97-percent-free-20260821-FIXED-20260829.md` |
