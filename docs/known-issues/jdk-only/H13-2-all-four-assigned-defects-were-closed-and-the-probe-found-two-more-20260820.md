...
| # | defect | record | state |
|---|---|---|---|
| 1 | `getInstance` ignores the requested provider | `docs/internal/fixed-suite-bugs/springboot/core-spring-boot-keystore-provider-name-swallowed-20260723-FIXED.md` | **FIXED, re-measured today** |
...
| 3 | a base-class native shadowing overloads a provider subclass does not override | `docs/internal/fixed-suite-bugs/bug-bcjava-jca-provider-alias-lookup-and-attribution-20260816.md` | **FIXED 2026-08-16**; residual in §4 |
| 4 | EC server identity rejected on JDK PKCS#8 v1 keys | `docs/internal/fixed-suite-bugs/netty/ec-server-identity-rejected-jdk-pkcs8-v1-20260812-FIXED.md` | **FIXED 2026-08-12**, in `t27_tls.rs` — **not a path this lane owns** |
