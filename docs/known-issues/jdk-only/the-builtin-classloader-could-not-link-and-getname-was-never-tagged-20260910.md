...
[`the-platform-loader-answers-from-the-application-class-path-20260911.md`](../../internal/jdk-only/the-platform-loader-answers-from-the-application-class-path-20260911.md)
...
**UPDATE 2026-09-17: FIXED.** `cl_get_resource_as_stream` now delegates
through `getResource()`+`openStream()` for every classloader shape rather
than only `URLClassLoader`/user-defined loaders — see the retired page (now
`the-platform-loader-answers-from-the-application-class-path-20260911.md`
under `../../internal/jdk-only`) for the measurement.
