...
> files and 126 525 lines, the whole probe corpus among them, and this lane's
...
"$JDK/bin/javac" -d apps/probes/out apps/probes/*ShadowSweep.java probes/MethodRefDoorProbe.java
