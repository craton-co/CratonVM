...
| `RJdkLogging` | not in scope — the `Formatter.formatMessage` half landed on dev after this measurement; the `inferCaller` half is tracked separately in jul-logrecord-infercaller-is-inert-under-jdk-only-20260812.md |
