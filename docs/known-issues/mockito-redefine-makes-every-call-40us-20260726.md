...
| | |
|---|---|
| **Status** | OPEN — root mechanism identified and reduced to a 90-second reproducer; not fixed. **Re-measured 2026-07-30** (see *2026-07-30 re-measurement* below): still ~33 000 ns/call, and the 2026-07-26 profile's leading hypothesis no longer holds. |
...
## 2026-07-30 re-measurement — the per-call re-quickening hypothesis is dead
