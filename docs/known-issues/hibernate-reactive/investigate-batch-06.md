# hibernate-reactive — investigate batch 06 of 6
...
**No investigation done — class names and repro only.** Part of a 71-class FAIL/HANG list split across 6 pages (see [investigate-INDEX.md](investigate-INDEX.md)) so work doesn't overlap. This page owns exactly the 11 classes below — do not touch classes listed in other batch pages.
...
|---|---|---|
| `org.hibernate.reactive.IdentityGeneratorWithColumnTransformerTest` | FAIL | g1=FAIL |
| `org.hibernate.reactive.ImplicitSoftDeleteTests` | FAIL | g1=FAIL |
| `org.hibernate.reactive.InternalStateAssertionsTest` | FAIL | g1=FAIL |
| `org.hibernate.reactive.JoinedInheritanceBatchTest` | FAIL | g1=FAIL |
| `org.hibernate.reactive.JoinedSubclassIdentityTest` | FAIL | g1=FAIL |
| `org.hibernate.reactive.JoinedSubclassInheritanceTest` | FAIL | g1=FAIL |
| `org.hibernate.reactive.LazyInitializationExceptionTest` | FAIL | g1=FAIL |
| `org.hibernate.reactive.LazyManyToOneAssociationTest` | HANG | g1=HANG |
| `org.hibernate.reactive.LazyOneToManyAssociationWithFetchTest` | HANG | g1=HANG |
| `org.hibernate.reactive.LazyOneToOneWithJoinColumnTest` | FAIL | g1=FAIL |
| `org.hibernate.reactive.LazyOrderedElementCollectionForEmbeddableTypeListTest` | FAIL | g1=FAIL |
