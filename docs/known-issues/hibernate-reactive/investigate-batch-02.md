# hibernate-reactive — investigate batch 02 of 6
...
|---|---|---|
| `org.hibernate.reactive.CollectionStatelessSessionListenerTest` | FAIL/HANG | default=HANG, g1=FAIL, zgc=FAIL |
| `org.hibernate.reactive.CompositeIdTest` | FAIL | default=FAIL, g1=FAIL, zgc=FAIL |
| `org.hibernate.reactive.CompositeIdWithGeneratedValuesTest` | FAIL/HANG | default=HANG, g1=FAIL, zgc=HANG |
| `org.hibernate.reactive.CriteriaMutationQueryTest` | FAIL/HANG | default=HANG, g1=FAIL, zgc=FAIL |
| `org.hibernate.reactive.CustomGeneratorTest` | FAIL/HANG | default=HANG, g1=FAIL, zgc=HANG |
| `org.hibernate.reactive.CustomOneToOneStoredProcedureSqlTest` | FAIL/HANG | default=HANG, g1=FAIL, zgc=HANG |
| `org.hibernate.reactive.CustomSqlTest` | FAIL/HANG | default=HANG, g1=FAIL, zgc=HANG |
| `org.hibernate.reactive.CustomStoredProcedureSqlTest` | FAIL/HANG | default=HANG, g1=FAIL, zgc=FAIL |
| `org.hibernate.reactive.DynamicUpdateTest` | FAIL/HANG | default=FAIL, g1=FAIL, zgc=HANG |
| `org.hibernate.reactive.EagerElementCollectionForBasicTypeListTest` | FAIL/HANG | default=FAIL, g1=FAIL, zgc=HANG |
| `org.hibernate.reactive.EagerElementCollectionForBasicTypeMapTest` | FAIL/HANG | default=FAIL, g1=FAIL, zgc=HANG |
| `org.hibernate.reactive.EagerElementCollectionForBasicTypeSetTest` | FAIL | g1=FAIL, zgc=FAIL |
