...
- **ZGC** is **not** stub-only. `ZgcRealHeap` (`gc/src/zgc.rs:1396`) is a real
  ...
  [`docs/internal/fixed-suite-bugs/springboot/zgc-real-fullsuite-regression-RETIRED-20260807.md`](internal/fixed-suite-bugs/springboot/zgc-real-fullsuite-regression-RETIRED-20260807.md).
