...
| [Production ZGC](zgc-production-implementation-plan.md) | Partial | The default collector. **Concurrent marking landed 2026-08-16** and compaction on 2026-08-13; the sweep is still stop-the-world, marking is snapshot-at-the-beginning rather than ZGC's load barrier, and it is not generational. See [the concurrent+generational plan](zgc-concurrent-and-generational-plan-20260813.md). |
