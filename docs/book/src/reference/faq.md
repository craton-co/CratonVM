...
Current performance depends heavily on JIT configuration. With
...
slower. Default launcher settings leave the one-shot hot loops mostly
interpreted, so the default QuickBench total is not competitive. See
