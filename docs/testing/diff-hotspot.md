...
| `--compatible` / `--real-jdk` | Works. The CratonVM side runs under the permissive policy, which is what the launcher default was until 2026-09-20. | Nothing to reconcile. |
