    ...
    static void sizeTruncateClose(Path dir) throws Exception {
        ...
        try {
            ...
            try {
                ...
                threw = true;
                // HotSpot's `SimpleAsynchronousFileChannelImpl.truncate` throws
                // the bare literal "Negative size" -- it does not echo the
                // value. Measured against HotSpot 25 (`apps/probes/L4Diag`):
