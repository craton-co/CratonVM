 ...
 *
 * <p>Diagnosed in {@code docs/jdk-only/E12-1-the-null-session-and-the-fabricated-cipher.md}.
 ...
 * {@code getSessionContext()} had <b>no registration at all</b> until lane F18
 * (retired to {@code docs/internal/retired/} once its findings landed and were measured).
