...
`` on this host, to avoid re-deriving already-tracked work.
...
| Class | Where tracked |
|---|---|
| `TestFileSystem` | `h2-suite-bugs/bug-h2-files-setposixfilepermissions-FIXED.md` — flags read-only `FileChannel.open` not enforcing write-protection as an open follow-up |
...
layout hypothesis, half-documented in `gaps/roadmap.md`
