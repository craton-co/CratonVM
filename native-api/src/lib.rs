...
pub mod path_layout;
/// The slot map of this VM's DEFAULT `java/nio/file/FileSystem` singleton
/// only, once minted as the real platform class -- companion to
/// `path_layout`, narrower scope. See the module's own doc for why jar/jrt
...
pub use registry::{
    ...
    NativeThreadAccess, NativeThreadBlocker, RAW_SLOT_DESCRIPTOR, ReadCursor, StackTraceEntry,
    ThreadJmxSnapshot, TypeArgAnnotations,
};
