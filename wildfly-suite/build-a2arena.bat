@echo off
REM A2 arena/breadcrumb iteration build. Unique output -> cvma2arena.exe.
cd /d "%~dp0"
...
if exist "target\release\cratonvm.exe" copy /Y "target\release\cratonvm.exe" "cvma2arena.exe"
