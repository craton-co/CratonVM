# bench/maven/run-under-cratonvm.ps1
# WP8.7 — run the staged maven fixture under cratonvm (Windows PS 5.1).
...
if (-not $Rustjvm) { Write-Error "run-maven: cratonvm.exe not found; cargo build --release -p cratonvm-cli"; exit 3 }
