# bench/tomcat10/run-under-rustjvm.ps1
# WP8.7 — run the staged tomcat10 fixture under rust-jvm (Windows PS 5.1).
...
if (-not $Rustjvm) { Write-Error "run-tomcat10: rustjvm.exe not found; cargo build --release -p rustjvm-cli"; exit 3 }
