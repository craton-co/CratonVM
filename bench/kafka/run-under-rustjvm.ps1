# bench/kafka/run-under-rustjvm.ps1
# WP8.7 — run the staged kafka fixture under rust-jvm (Windows PS 5.1).
...
if (-not $Rustjvm) { Write-Error "run-kafka: rustjvm.exe not found; cargo build --release -p rustjvm-cli"; exit 3 }
