# bench/jetty12/run-under-cratonvm.ps1
# WP8.7 — run the staged jetty12 fixture under cratonvm (Windows PS 5.1).
...
if (-not $Rustjvm) { Write-Error "run-jetty12: cratonvm.exe not found; cargo build --release -p cratonvm-cli"; exit 3 }
