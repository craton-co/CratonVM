# bench/ejbca-deploy/run-under-cratonvm.ps1
# WP8.11 — Boot WildFly+EJBCA under target/release/cratonvm.exe and poll
# https://localhost:8443/ejbca/. Mirrors run-under-cratonvm.sh.
...
$WildflyRunPs1 = Join-Path $WildflyFixture 'run-under-cratonvm.ps1'
