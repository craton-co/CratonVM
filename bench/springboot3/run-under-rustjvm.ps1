# bench/springboot3/run-under-rustjvm.ps1
# WP8.7 — run the staged springboot3 fixture under rust-jvm (Windows PS 5.1).
...
if (-not $Rustjvm) { Write-Error "run-springboot3: rustjvm.exe not found; cargo build --release -p rustjvm-cli"; exit 3 }
