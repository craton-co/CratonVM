 ...
 * three warm calls of 200 inner reps (60M characters) before the measured one.
 * On CratonVM this prints ~3 ns/char where `CharAtCostCurve` prints ~190; on
 * HotSpot both print ~0.5.
 *
 * Keep the three warm reps at 200. Dropping them to 50 loses the fast body
 * entirely (measured 340 ns/char), which is the whole point of this probe:
 * the fast path exists and is not steerable by anything documented.
 *
