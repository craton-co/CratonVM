...
which reports roughly 2,343,000 lines (2,342,837 on 2026-09-19 after the round-9
JIT review merged with dev; 2,273,319 on 2026-09-17, up from
2,204,853 on 2026-09-12 — the jit and native-api growth recorded below, plus
the 62-commit dev merge landed during the lane-4 WindowsPath.type/.root
session) across 1,028 files. Re-measure before quoting it: this figure and the
...
| Crate | LoC | Crate | LoC |
|-------|----:|-------|----:|
| `native-builtins` | 774,000 | `native-awt` | 18,000 |
| `vm` | 505,000 | `types` | 45,000 |
| `jit` | 384,000 | `native-api` | 56,000 |
| `gc` | 195,000 | `reader` | 17,000 |
