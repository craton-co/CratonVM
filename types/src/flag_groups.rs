...
pub const INVENTORY: &[E] = &[
    ...
    E { group: Group::DBG, token: "deoptslot", on_key: Some("CRATONVM_DBG_DEOPTSLOT"), off_key: None, off_word: None },
    ...
    E { group: Group::DBG, token: "hw-atomic", on_key: Some("CRATONVM_DBG_HW_ATOMIC"), off_key: None, off_word: None },
    E { group: Group::DBG, token: "jca-getinstance", on_key: Some("CRATONVM_DBG_JCA_GETINSTANCE"), off_key: None, off_word: None },
    ...
    E { group: Group::DBG, token: "quiet-env-fallback", on_key: Some("CRATONVM_QUIET_ENV_FALLBACK"), off_key: None, off_word: None },
    ...
    E { group: Group::DBG, token: "setacc", on_key: Some("CRATONVM_DBG_SETACC"), off_key: None, off_word: None },
    ...
    E { group: Group::DBG, token: "stamped", on_key: Some("CRATONVM_DBG_STAMPED"), off_key: None, off_word: None },
    ...
    E { group: Group::DBG, token: "stub-bt", on_key: Some("CRATONVM_DBG_STUB_BT"), off_key: None, off_word: None },
    E { group: Group::DBG, token: "stubloader", on_key: Some("CRATONVM_DBG_STUBLOADER"), off_key: None, off_word: None },
    ...
    E { group: Group::DBG, token: "trivial-getter-verify", on_key: Some("CRATONVM_TRIVIAL_GETTER_VERIFY"), off_key: None, off_word: None },
    ...
    E { group: Group::DBG, token: "young-trigger", on_key: Some("CRATONVM_DBG_YOUNG_TRIGGER"), off_key: None, off_word: None },
    ...
    E { group: Group::JIT, token: "frame-bands", on_key: None, off_key: Some("CRATONVM_JIT_NO_FRAME_BANDS"), off_word: None },
    E { group: Group::JIT, token: "oopmap-coverage-presence-only", on_key: Some("CRATONVM_JIT_OOPMAP_COVERAGE_PRESENCE_ONLY"), off_key: None, off_word: None },
    E { group: Group::GC, token: "moving-young-bounds-guard", on_key: None, off_key: Some("CRATONVM_MOVING_YOUNG_NO_BOUNDS_GUARD"), off_word: None },
    ...
    E { group: Group::JIT, token: "osr-ctor-bind", on_key: None, off_key: Some("CRATONVM_NO_OSR_CTOR_BIND"), off_word: None },
    E { group: Group::JIT, token: "real-new-site-flags", on_key: Some("CRATONVM_JIT_REAL_NEW_SITE_FLAGS"), off_key: None, off_word: None },
    ...
    E { group: Group::JIT, token: "trusted-oop-getfield", on_key: None, off_key: Some("CRATONVM_JIT_NO_TRUSTED_OOP_GETFIELD"), off_word: None },
    ...
    E { group: Group::JIT, token: "varhandle-cas-direct-helpers", on_key: Some("CRATONVM_JIT_VARHANDLE_CAS_DIRECT_HELPERS"), off_key: None, off_word: Some("0") },
    E { group: Group::JIT, token: "varhandle-ref-read-direct", on_key: Some("CRATONVM_JIT_VARHANDLE_REF_READ_DIRECT"), off_key: None, off_word: Some("0") },
    ...
    E { group: Group::JIT, token: "matrix-dot", on_key: Some("CRATONVM_JIT_MATRIX_DOT"), off_key: None, off_word: Some("0") },
    ...
    E { group: Group::JIT, token: "my-scratch-flush", on_key: Some("CRATONVM_JIT_MY_SCRATCH_FLUSH"), off_key: None, off_word: Some("0") },
    E { group: Group::JIT, token: "my-selfcall-proof", on_key: Some("CRATONVM_JIT_MY_SELFCALL_PROOF"), off_key: None, off_word: Some("0") },
    E { group: Group::JIT, token: "my-shadow-emission", on_key: Some("CRATONVM_JIT_MY_SHADOW_EMISSION"), off_key: None, off_word: Some("0") },
    ...
    E { group: Group::JIT, token: "tlab-zero-elision", on_key: None, off_key: Some("CRATONVM_NO_JIT_TLAB_ZERO_ELISION"), off_word: None },
    ...
    E { group: Group::GC, token: "precise-only-roots", on_key: Some("CRATONVM_GC_PRECISE_ONLY_ROOTS"), off_key: None, off_word: None },
    ...
    E { group: Group::GC, token: "g1-parallel-evac-in-jit", on_key: Some("CRATONVM_G1_PARALLEL_EVAC_IN_JIT"), off_key: None, off_word: Some("0") },
    ...
    E { group: Group::GC, token: "g1-adaptive-ihop", on_key: Some("CRATONVM_G1_ADAPTIVE_IHOP"), off_key: None, off_word: Some("0") },
    E { group: Group::GC, token: "g1-adaptive-tenuring", on_key: Some("CRATONVM_G1_ADAPTIVE_TENURING"), off_key: None, off_word: Some("0") },
    E { group: Group::GC, token: "g1-reserve-heap", on_key: Some("CRATONVM_G1_RESERVE_HEAP"), off_key: None, off_word: Some("0") },
    E { group: Group::GC, token: "g1-uncommit", on_key: Some("CRATONVM_G1_UNCOMMIT"), off_key: None, off_word: None },
    E { group: Group::GC, token: "g1-card-rset", on_key: Some("CRATONVM_G1_CARD_RSET"), off_key: None, off_word: Some("0") },
    E { group: Group::GC, token: "g1-inline-barrier", on_key: Some("CRATONVM_G1_INLINE_BARRIER"), off_key: None, off_word: None },
    ...
    E { group: Group::GC, token: "g1-parallel-mark", on_key: Some("CRATONVM_G1_PARALLEL_MARK"), off_key: None, off_word: Some("0") },
    ...
    E { group: Group::LOADER, token: "parent-chain", on_key: Some("CRATONVM_LOADER_PARENT_CHAIN"), off_key: None, off_word: Some("0") },
    E { group: Group::LOADER, token: "resolve-cache-cap", on_key: Some("CRATONVM_RESOLVE_CACHE_CAP"), off_key: None, off_word: None },
    E { group: Group::LOADER, token: "stub-delegation", on_key: Some("CRATONVM_CL_STUB_DELEGATION"), off_key: None, off_word: None },
    ...
    E { group: Group::SECURITY, token: "capability-grants", on_key: Some("CRATONVM_CAPABILITY_GRANTS"), off_key: None, off_word: None },
    E { group: Group::SECURITY, token: "capability-log", on_key: Some("CRATONVM_CAPABILITY_LOG"), off_key: None, off_word: None },
    E { group: Group::SECURITY, token: "capability-mode", on_key: Some("CRATONVM_CAPABILITY_MODE"), off_key: None, off_word: None },
