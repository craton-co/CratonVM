...
pub const INVENTORY: &[E] = &[
    ...
    E { group: Group::JIT, token: "ir-carry-2nd", on_key: Some("CRATONVM_JIT_IR_CARRY_2ND"), off_key: None, off_word: None, since: "2026-09-10" },
    E { group: Group::JIT, token: "ir-pair-operands", on_key: Some("CRATONVM_JIT_IR_PAIR_OPERANDS"), off_key: None, off_word: None, since: "2026-09-10" },
    E { group: Group::JIT, token: "ir-carry-rcx-folded", on_key: Some("CRATONVM_JIT_IR_CARRY_RCX_FOLDED"), off_key: None, off_word: None, since: "2026-09-10" },
