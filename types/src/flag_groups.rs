...
pub const INVENTORY: &[E] = &[
    ...
    // on 2026-09-09; see `ir_splice_multi_return_enabled`). Implied by
    // `ir-recursive-inline`, which needs it for a callee's base-case return.
    ...
    E { group: Group::JIT, token: "ir-recursive-inline", on_key: Some("CRATONVM_JIT_IR_RECURSIVE_INLINE"), off_key: None, off_word: None, since: "2026-09-18" },
    ...
    E { group: Group::JIT, token: "ir-range-edges", on_key: Some("CRATONVM_JIT_IR_RANGE_EDGES"), off_key: None, off_word: None, since: "2026-09-17" },
    ...
    // `x64::vec_emit::VecEmitPolicy::from_flags` (no production caller) still
    // reads unset as Disabled.
    ...
    E { group: Group::GC, token: "zgc-lazy-tlab-zero", on_key: Some("CRATONVM_ZGC_LAZY_TLAB_ZERO"), off_key: None, off_word: None, since: "2026-09-19" },
