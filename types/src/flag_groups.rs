...
pub const INVENTORY: &[E] = &[
    ...
    // Declared 2026-08-28. An OPT-OUT: an allocation failure names the window
    ...
    E { group: Group::GC, token: "targeted-compaction", on_key: None, off_key: Some("CRATONVM_ZGC_NO_TARGETED_COMPACTION"), off_word: None },
