...
```bash
rustjvm-cli --classpath examples HelloWorld
```
...
Compile examples with `javac examples/*.java`, then run with `rustjvm-cli --classpath examples <ClassName>`.
