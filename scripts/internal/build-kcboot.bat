@echo off
REM Isolated, taskkill-resistant release build for the keycloak-gap5 worktree.
cd /d "%~dp0.."
...
"C:\Users\Victor\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin\kccargo.exe" build --release -p cratonvm-cli --target-dir target-kcboot %*
