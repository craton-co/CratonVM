@echo off
REM A2 free-list-source diagnostic build. Unique output -> cvma2flsrc.exe.
cd /d "%~dp0"
...
if exist "target\release\cratonvm.exe" copy /Y "target\release\cratonvm.exe" "cvma2flsrc.exe"
