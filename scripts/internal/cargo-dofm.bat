@echo off
REM Flexible cargo wrapper for the MAIN worktree (dev) — unique dof toolchain copies.
cd /d "%~dp0"
...
set "RUSTC=C:\Users\Victor\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin\rsc_dof.exe"
"C:\Users\Victor\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin\cgo_dof.exe" %*
