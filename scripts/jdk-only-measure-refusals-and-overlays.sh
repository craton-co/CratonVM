...
for k in ("jit_direct_native_binds", "jit_inline_cache_natives",
          ...
          # 2026-09-22. The thin JIT direct-call helpers' own gate, plus
          # its denominator. The refusal column alone reads zero both when
          # strict mode blocked nothing and when no compiled site ever
          # reached a guarded helper; only the admissions beside it tell
          # those apart.
          "jit_direct_helper_fastpaths", "jit_direct_helper_admissions",
