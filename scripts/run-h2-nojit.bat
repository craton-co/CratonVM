@echo off
REM Run H2 org.h2.test.TestAll --nojit on the worktree (current-dev) build.
...
C:\craton\CratonVM-h2val\target\release\cratonvm.exe --java-home "C:/Program Files/Java/jdk-25" --nojit --stack-dump-on-timeout 0 -Xmx1g -cp "%CP%" org.h2.test.TestAll
