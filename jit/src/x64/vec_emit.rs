...
//! reason: JVM arithmetic on them is performed in `int` on sign- (or, for
//! `char`, zero-) extended operands and narrowed only at the store. For `+ - *
...
//! way to say "this value is only ever narrowed". Until it does, sub-word
//! elements stay refused; see `docs/jit/vectorization-emitter.md`.
//!
//! # Registers
//!
