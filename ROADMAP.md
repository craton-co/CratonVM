...
[`docs/jdk-only/README.md`](docs/jdk-only/README.md),
...
Two standing constraints on all of it: `--compatible` mode (the launcher
default until 2026-09-20, and still every embedder's) must remain
