 ...
 * (and its subclass ReentrantLock) runs real JDK bytecode. The test acquires
 * a lock on the main thread, observes it from a second thread, releases it,
 * and confirms both the locked and unlocked states.
 */
public class RealAqs {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("REAL_AQS_OK 3");
    }
}
