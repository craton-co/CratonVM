...
pub(crate) fn aastore_element_assignable(
    ...
    // docs/jdk-only/W8-C16-1-serializable-cloneable-are-not-object.md
...
///
/// docs/jdk-only/W8-C16-2-synthetic-implements-simple-name.md
...
pub(super) fn synthetic_implements(
    ...
    // build. docs/jdk-only/W8-C16-2-synthetic-implements-simple-name.md
...
mod f32_pure_predicate_tests {
    ...
    fn a_container_never_lends_its_name_and_a_cursor_is_never_a_collection() {
        ...
        // docs/jdk-only/F32-1-the-proxy-route-and-the-drifted-twin-20260813.md §6.
    }
}
