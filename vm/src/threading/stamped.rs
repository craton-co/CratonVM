...
pub use rustjvm_native_builtins::stamped_lock::{
    ...
    rw_write_lock,
    rw_write_unlock,
    stamped_get_read_lock_count,
    stamped_init,
    stamped_is_read_locked,
    stamped_is_write_locked,
    stamped_read_lock,
    stamped_try_convert_to_read,
    stamped_try_convert_to_write,
    stamped_try_optimistic_read,
    stamped_try_read_lock,
    stamped_try_write_lock,
    stamped_unlock_read,
    stamped_unlock_write,
    stamped_validate,
    stamped_write_lock,
    STAMPED_ORIGIN,
};
