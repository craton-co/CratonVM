...
mod tests {
    ...
    #[test]
    fn elasticsearch_vector_diskbbq_hang_cluster_is_jit_eligible() {
        // Stale test found 2026-07-28: the ES fragile-cluster ban this
        // asserted was already removed 2026-07-27 (see the consolidated
        // tracker doc), and separately, ElasticSearch is not one of the
        // 5 apps (tomcat/hibernate/spring/spring-boot/h2) this session is
        // scoped to, so no ES-specific ban is being re-added here either
        // way.
        for class_name in [
            ...
            assert_eq!(
                ...
                None,
                "{class_name} must be JIT-eligible -- the ES fragile-cluster ban is gone"
            );
            assert_eq!(
