...
fn should_skip_jit_internal(
    ...
    if policy == SkipPolicy::Conservative {
        ...
        // See `docs/internal/fixed-suite-bugs/wildfly/modeltypevalidator-validtypes-npe.md` for
        // the full write-up, including the per-package results for the four
        // sibling bans (which stay in place).
