...
// scalar via sum += (long) a[i] * b[i]. dotReduce() below is the
// proven-eligible reduction shape from test_classes/gpu/EligibleDotProduct.java
// (mirrored verbatim in bench-gpu/GpuProbe.dotReduce): a single counted loop,
// scalar long accumulator, no array store, no calls -> the analyzer marks it
